...
@:uextern @:uclass extern class UNiagaraComponent extends unreal.UPrimitiveComponent {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetNiagaraEmitterSpawnRate(InEmitterName : unreal.FString, InValue : unreal.Float32) : Void;
  
  /**
    Sets a Niagara static mesh data interface's Source parameter by name, overriding locally if necessary.
  **/
  @:ufunction(BlueprintCallable) @:final public function SetNiagaraStaticMeshDataInterfaceActor(InVariableName : unreal.FString, InSource : unreal.AActor) : Void;
  
  /**
    Resets the effect to it's initial pre-simulated state.
  **/
  @:ufunction(BlueprintCallable) @:final public function ResetEffect() : Void;
  
  /**
    Called on when an external object wishes to force this effect to reinitialize itself from the effect data.
  **/
  @:ufunction(BlueprintCallable) @:final public function ReinitializeEffect() : Void;
