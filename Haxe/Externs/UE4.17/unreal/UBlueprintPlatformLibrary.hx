...
@:uextern @:uclass extern class UBlueprintPlatformLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  /**
    ...
    @param ActivationEvent A string that is passed in the delegate callback when the app is brought into the foreground from the user activating the notification
  **/
  @:ufunction static public function ScheduleLocalNotificationBadgeAtTime(FireDateTime : unreal.Const<unreal.PRef<unreal.FDateTime>>, LocalTime : Bool, ActivationEvent : unreal.FString) : Void;
  ...
  /**
    ...
    @param ActivationEvent A string that is passed in the delegate callback when the app is brought into the foreground from the user activating the notification
  **/
  @:ufunction static public function ScheduleLocalNotificationBadgeFromNow(inSecondsFromNow : unreal.Int32, ActivationEvent : unreal.FString) : Void;
