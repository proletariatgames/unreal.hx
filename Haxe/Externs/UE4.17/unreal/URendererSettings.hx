...
@:uextern @:uclass extern class URendererSettings extends unreal.UDeveloperSettings {
  ...
  **/
  ...
  /**
    Enable direct mobile multi-view rendering (only available on multi-view enabled GearVR and Daydream Android devices).
  **/
  @:uproperty public var bMobileMultiViewDirect : Bool;
  
  /**
    Enable mobile multi-view rendering (only available on some GearVR Android devices using OpenGL ES 2.0).
  **/
