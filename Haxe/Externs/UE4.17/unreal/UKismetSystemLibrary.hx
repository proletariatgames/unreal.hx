...
@:uextern @:uclass extern class UKismetSystemLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  /**
    Returns the platform specific unique device id
  **/
  @:ufunction static public function GetDeviceId() : unreal.FString;
  ...
  **/
  @:ufunction static public function PrintString(WorldContextObject : unreal.UObject, InString : unreal.FString = "Hello", bPrintToScreen : Bool = true, bPrintToLog : Bool = true, @:opt("(R=0.000000,G=0.660000,B=1.000000,A=1.000000)") TextColor : unreal.FLinearColor, Duration : unreal.Float32 = 2.000000) : Void;
  ...
  /**
    ...
    @param       Duration                The display duration (if Print to Screen is True). Using negative number will result in loading the duration time from the config.
  **/
  @:ufunction static public function PrintText(WorldContextObject : unreal.UObject, InText : unreal.Const<unreal.FText> = "Hello", bPrintToScreen : Bool = true, bPrintToLog : Bool = true, @:opt("(R=0.000000,G=0.660000,B=1.000000,A=1.000000)") TextColor : unreal.FLinearColor, Duration : unreal.Float32 = 2.000000) : Void;
  ...
  **/
  @:ufunction static public function K2_SetTimerDelegate(Delegate : unreal.FTimerDynamicDelegate, Time : unreal.Float32, bLooping : Bool) : unreal.FTimerHandle;
  
  /**
    Clears a set timer.
    @param Event  Can be a K2 function or a Custom Event.
  **/
  @:ufunction static public function K2_ClearTimerDelegate(Delegate : unreal.FTimerDynamicDelegate) : Void;
  
  /**
    Pauses a set timer at its current elapsed time.
    @param Event  Can be a K2 function or a Custom Event.
  **/
  @:ufunction static public function K2_PauseTimerDelegate(Delegate : unreal.FTimerDynamicDelegate) : Void;
  
  /**
    Resumes a paused timer from its current elapsed time.
    @param Event  Can be a K2 function or a Custom Event.
  **/
  @:ufunction static public function K2_UnPauseTimerDelegate(Delegate : unreal.FTimerDynamicDelegate) : Void;
  ...
  **/
  @:ufunction static public function K2_IsTimerActiveDelegate(Delegate : unreal.FTimerDynamicDelegate) : Bool;
  ...
  **/
  @:ufunction static public function K2_IsTimerPausedDelegate(Delegate : unreal.FTimerDynamicDelegate) : Bool;
  ...
  **/
  @:ufunction static public function K2_TimerExistsDelegate(Delegate : unreal.FTimerDynamicDelegate) : Bool;
  ...
  **/
  @:ufunction static public function K2_GetTimerElapsedTimeDelegate(Delegate : unreal.FTimerDynamicDelegate) : unreal.Float32;
  ...
  **/
  @:ufunction static public function K2_GetTimerRemainingTimeDelegate(Delegate : unreal.FTimerDynamicDelegate) : unreal.Float32;
  ...
  **/
  @:ufunction static public function LineTraceSingle(WorldContextObject : unreal.UObject, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  **/
  @:ufunction static public function LineTraceMulti(WorldContextObject : unreal.UObject, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                              True if there was a hit, false otherwise.
  **/
  @:ufunction static public function SphereTraceSingle(WorldContextObject : unreal.UObject, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                              True if there was a blocking hit, false otherwise.
  **/
  @:ufunction static public function SphereTraceMulti(WorldContextObject : unreal.UObject, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  **/
  ...
  /**
    ...
    @return                              True if there was a hit, false otherwise.
  **/
  @:ufunction static public function CapsuleTraceSingle(WorldContextObject : unreal.UObject, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, HalfHeight : unreal.Float32, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                              True if there was a blocking hit, false otherwise.
  **/
  @:ufunction static public function CapsuleTraceMulti(WorldContextObject : unreal.UObject, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, HalfHeight : unreal.Float32, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a hit, false otherwise.
  **/
  @:ufunction static public function LineTraceSingleByProfile(WorldContextObject : unreal.UObject, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a blocking hit, false otherwise.
  **/
  @:ufunction static public function LineTraceMultiByProfile(WorldContextObject : unreal.UObject, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a hit, false otherwise.
  **/
  @:ufunction static public function SphereTraceSingleByProfile(WorldContextObject : unreal.UObject, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a blocking hit, false otherwise.
  **/
  @:ufunction static public function SphereTraceMultiByProfile(WorldContextObject : unreal.UObject, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  **/
  ...
  /**
    ...
    @return                               True if there was a blocking hit, false otherwise.
  **/
  @:ufunction static public function BoxTraceMultiByProfile(WorldContextObject : unreal.UObject, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, HalfSize : unreal.FVector, Orientation : unreal.Const<unreal.FRotator>, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  **/
  @:ufunction static public function GetDefaultLanguage() : unreal.FString;
  ...
  **/
  @:ufunction static public function GetDefaultLocale() : unreal.FString;
  ...
  **/
  ...
  /**
    ...
    (Android only)
  **/
  @:ufunction static public function UnregisterForRemoteNotifications() : Void;
  ...
  **/
  @:ufunction static public function GetCommandLine() : unreal.FString;
  ...
  **/
  @:ufunction static public function GetObjectFromPrimaryAssetId(PrimaryAssetId : unreal.FPrimaryAssetId) : unreal.UObject;
  ...
  **/
  @:ufunction static public function GetClassFromPrimaryAssetId(PrimaryAssetId : unreal.FPrimaryAssetId) : unreal.TSubclassOf<unreal.UObject>;
  
  /**
    Returns the Primary Asset Id for an Object, this can return an invalid one if not registered
  **/
  @:ufunction static public function GetPrimaryAssetIdFromObject(Object : unreal.UObject) : unreal.FPrimaryAssetId;
  
  /**
    Returns the Primary Asset Id for a Class, this can return an invalid one if not registered
  **/
  @:ufunction static public function GetPrimaryAssetIdFromClass(Class : unreal.TSubclassOf<unreal.UObject>) : unreal.FPrimaryAssetId;
  
  /**
    Returns list of PrimaryAssetIds for a PrimaryAssetType
  **/
  @:ufunction static public function GetPrimaryAssetIdList(PrimaryAssetType : unreal.FPrimaryAssetType, OutPrimaryAssetIdList : unreal.PRef<unreal.TArray<unreal.FPrimaryAssetId>>) : Void;
  
  /**
    Returns true if the Primary Asset Id is valid
  **/
  @:ufunction static public function IsValidPrimaryAssetId(PrimaryAssetId : unreal.FPrimaryAssetId) : Bool;
  
  /**
    Returns true if the values are equal (A == B)
  **/
  @:ufunction static public function EqualEqual_PrimaryAssetId(A : unreal.FPrimaryAssetId, B : unreal.FPrimaryAssetId) : Bool;
  
  /**
    Returns true if the values are not equal (A != B)
  **/
  @:ufunction static public function NotEqual_PrimaryAssetId(A : unreal.FPrimaryAssetId, B : unreal.FPrimaryAssetId) : Bool;
  
  /**
    Returns list of PrimaryAssetIds for a PrimaryAssetType
  **/
  @:ufunction static public function IsValidPrimaryAssetType(PrimaryAssetType : unreal.FPrimaryAssetType) : Bool;
  
  /**
    Returns true if the values are equal (A == B)
  **/
  @:ufunction static public function EqualEqual_PrimaryAssetType(A : unreal.FPrimaryAssetType, B : unreal.FPrimaryAssetType) : Bool;
  
  /**
    Returns true if the values are not equal (A != B)
  **/
  @:ufunction static public function NotEqual_PrimaryAssetType(A : unreal.FPrimaryAssetType, B : unreal.FPrimaryAssetType) : Bool;
  
  /**
    Unloads a primary asset, which allows it to be garbage collected if nothing else is referencing it
  **/
  @:ufunction static public function UnloadPrimaryAsset(PrimaryAssetId : unreal.FPrimaryAssetId) : Void;
  
  /**
    Unloads a primary asset, which allows it to be garbage collected if nothing else is referencing it
  **/
  @:ufunction static public function UnloadPrimaryAssetList(PrimaryAssetIdList : unreal.Const<unreal.PRef<unreal.TArray<unreal.FPrimaryAssetId>>>) : Void;
  ...
  **/
  @:ufunction static public function GetCurrentBundleState(PrimaryAssetId : unreal.FPrimaryAssetId, bForceCurrentState : Bool, OutBundles : unreal.PRef<unreal.TArray<unreal.FName>>) : Bool;
