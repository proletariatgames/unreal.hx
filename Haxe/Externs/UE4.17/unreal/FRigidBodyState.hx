...
@:noCopy @:noEquals @:uextern @:ustruct extern class FRigidBodyState {
  ...
  @:uproperty public var LinVel : unreal.FVector_NetQuantize100;
  @:uproperty public var Quaternion : unreal.FQuat;
  @:uproperty public var Position : unreal.FVector_NetQuantize100;
