...
@:uextern @:uclass extern class UWidgetBlueprintLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) static public function SetInputMode_UIOnly(Target : unreal.APlayerController, InWidgetToFocus : unreal.umg.UWidget, bLockMouseToViewport : Bool = false) : Void;
  
  /**
    Setup an input mode that allows only the UI to respond to user input.
  **/
  @:ufunction(BlueprintCallable) static public function SetInputMode_UIOnlyEx(Target : unreal.APlayerController, InWidgetToFocus : unreal.umg.UWidget, @:opt("DoNotLock") InMouseLockMode : unreal.EMouseLockMode) : Void;
  @:ufunction(BlueprintCallable) static public function SetInputMode_GameAndUI(Target : unreal.APlayerController, InWidgetToFocus : unreal.umg.UWidget, bLockMouseToViewport : Bool = false, bHideCursorDuringCapture : Bool = true) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetInputMode_GameAndUIEx(Target : unreal.APlayerController, InWidgetToFocus : unreal.umg.UWidget, @:opt("DoNotLock") InMouseLockMode : unreal.EMouseLockMode, bHideCursorDuringCapture : Bool = true) : Void;
  
  /**
    Setup an input mode that allows only player input / player controller to respond to user input.
  **/
  @:ufunction(BlueprintCallable) static public function SetInputMode_GameOnly(Target : unreal.APlayerController) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetBrushResource(Brush : unreal.PRef<unreal.slatecore.FSlateBrush>) : unreal.UObject;
  
  /**
    Gets the brush resource as a texture 2D.
  **/
  @:ufunction(BlueprintCallable) static public function GetBrushResourceAsTexture2D(Brush : unreal.PRef<unreal.slatecore.FSlateBrush>) : unreal.UTexture2D;
  
  /**
    Gets the brush resource as a material.
  **/
  @:ufunction(BlueprintCallable) static public function GetBrushResourceAsMaterial(Brush : unreal.PRef<unreal.slatecore.FSlateBrush>) : unreal.UMaterialInterface;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetSafeZonePadding(WorldContextObject : unreal.UObject, SafePadding : unreal.PRef<unreal.FVector2D>, SafePaddingScale : unreal.PRef<unreal.FVector2D>, SpillOverPadding : unreal.PRef<unreal.FVector2D>) : Void;
