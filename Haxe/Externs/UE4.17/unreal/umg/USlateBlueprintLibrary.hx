...
@:uextern @:uclass extern class USlateBlueprintLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction static public function GetAbsoluteSize(Geometry : unreal.Const<unreal.PRef<unreal.slatecore.FGeometry>>) : unreal.FVector2D;
  
  /**
    @return Whether brushes A and B are identical.
  **/
  @:ufunction static public function EqualEqual_SlateBrush(A : unreal.Const<unreal.PRef<unreal.slatecore.FSlateBrush>>, B : unreal.Const<unreal.PRef<unreal.slatecore.FSlateBrush>>) : Bool;
