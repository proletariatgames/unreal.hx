...
@:uextern @:uclass extern class UMediaPlaylist extends unreal.UObject {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function Add(MediaSource : unreal.mediaassets.UMediaSource) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function GetRandom(InOutIndex : unreal.Int32) : unreal.mediaassets.UMediaSource;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function Remove(MediaSource : unreal.mediaassets.UMediaSource) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function RemoveAt(Index : unreal.Int32) : Void;
