...
@:uextern @:uclass extern class UInterpGroup extends unreal.UObject {
  ...
  **/
  @:uproperty public var bIsParented : Bool;
  ...
  **/
  @:uproperty public var bIsFolder : Bool;
  ...
  **/
  @:uproperty public var GroupColor : unreal.FColor;
  ...
  **/
  ...
  @:uproperty public var InterpTracks : unreal.TArray<unreal.UInterpTrack>;
