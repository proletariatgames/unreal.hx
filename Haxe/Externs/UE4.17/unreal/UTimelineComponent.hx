...
@:uextern @:uclass extern class UTimelineComponent extends unreal.UActorComponent {
  ...
  **/
  @:ufunction @:final public function SetPlaybackPosition(NewPosition : unreal.Float32, bFireEvents : Bool, bFireUpdate : Bool = true) : Void;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetTimelineLength() : unreal.Float32;
  
  /**
    Set length of the timeline
  **/
  @:ufunction @:final public function SetTimelineLength(NewLength : unreal.Float32) : Void;
  
  /**
    Sets the length mode of the timeline
  **/
  @:ufunction @:final public function SetTimelineLengthMode(NewLengthMode : unreal.ETimelineLengthMode) : Void;
  
  /**
    Set whether to ignore time dilation.
  **/
  @:ufunction @:final public function SetIgnoreTimeDilation(bNewIgnoreTimeDilation : Bool) : Void;
  
  /**
    Get whether to ignore time dilation.
  **/
  @:ufunction @:thisConst @:final public function GetIgnoreTimeDilation() : Bool;
  
  /**
    Update a certain float track's curve
  **/
  @:ufunction @:final public function SetFloatCurve(NewFloatCurve : unreal.UCurveFloat, FloatTrackName : unreal.FName) : Void;
  
  /**
    Update a certain vector track's curve
  **/
  @:ufunction @:final public function SetVectorCurve(NewVectorCurve : unreal.UCurveVector, VectorTrackName : unreal.FName) : Void;
  
  /**
    Update a certain linear color track's curve
  **/
  @:ufunction @:final public function SetLinearColorCurve(NewLinearColorCurve : unreal.UCurveLinearColor, LinearColorTrackName : unreal.FName) : Void;
