...
@:uextern @:uclass extern class UMovieSceneBuiltInEasingFunction extends unreal.UObject implements unreal.moviescene.IMovieSceneEasingFunction {
  @:uproperty public var Type : unreal.moviescene.EMovieSceneBuiltInEasing;
