...
@:uextern @:uclass extern class UAndroidRuntimeSettings extends unreal.UObject {
  ...
  **/
  @:uproperty public var RenderDocPath : unreal.FDirectoryPath;
  ...
  **/
  @:uproperty public var bBuildForESDeferred : Bool;
  ...
  **/
  @:uproperty public var bBuildForX86 : Bool;
  ...
  **/
  @:uproperty public var GoogleVRMode : unreal.androidruntimesettings.EGoogleVRMode;
