...
@:uextern @:uclass extern class UAudioComponent extends unreal.USceneComponent {
  ...
  **/
  @:ufunction @:final public function SetLowPassFilterEnabled(InLowPassFilterEnabled : Bool) : Void;
  
  /**
    Sets lowpass filter frequency of the audio component.
  **/
  @:ufunction @:final public function SetLowPassFilterFrequency(InLowPassFilterFrequency : unreal.Float32) : Void;
