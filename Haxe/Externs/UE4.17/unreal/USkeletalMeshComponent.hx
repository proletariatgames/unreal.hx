...
@:uextern @:uclass extern class USkeletalMeshComponent extends unreal.USkinnedMeshComponent implements unreal.IInterface_CollisionDataProvider {
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetAnimInstanceClass(NewClass : unreal.UClass) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function IsClothingSimulationSuspended() : Bool;
