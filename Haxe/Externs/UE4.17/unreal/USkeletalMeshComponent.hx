...
@:uextern @:uclass extern class USkeletalMeshComponent extends unreal.USkinnedMeshComponent implements unreal.IInterface_CollisionDataProvider {
  @:uproperty public var LastPoseTickTime : unreal.Float32;
  ...
  **/
  @:uproperty public var bDeferMovementFromSceneQueries : Bool;
  ...
  **/
  @:uproperty public var bClothMorphTarget : Bool;
  ...
  **/
  ...
  @:ufunction @:final public function SetAnimInstanceClass(NewClass : unreal.UClass) : Void;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetAnimInstance() : unreal.UAnimInstance;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetPostProcessInstance() : unreal.UAnimInstance;
  
  /**
    Below are the interface to control animation when animation mode, not blueprint mode *
  **/
  @:ufunction @:final public function SetAnimationMode(InAnimationMode : unreal.EAnimationMode) : Void;
  @:ufunction @:thisConst @:final public function GetAnimationMode() : unreal.EAnimationMode;
  ...
  **/
  @:ufunction @:final public function PlayAnimation(NewAnimToPlay : unreal.UAnimationAsset, bLooping : Bool) : Void;
  ...
  /**
    Animation play functions
          ...
          * Please use OverrideAnimationDatat for construction script. That will override AnimationData to be serialized
  **/
  @:ufunction @:final public function SetAnimation(NewAnimToPlay : unreal.UAnimationAsset) : Void;
  ...
  /**
    Animation play functions
          ...
          * Please use OverrideAnimationDatat for construction script. That will override AnimationData to be serialized
  **/
  @:ufunction @:final public function Play(bLooping : Bool) : Void;
  ...
  **/
  ...
  /**
    Animation play functions
          ...
          * Please use OverrideAnimationDatat for construction script. That will override AnimationData to be serialized
  **/
  @:ufunction @:final public function SetPosition(InPos : unreal.Float32, bFireNotifies : Bool = true) : Void;
  ...
  /**
    Animation play functions
          ...
          * Please use OverrideAnimationDatat for construction script. That will override AnimationData to be serialized
  **/
  @:ufunction @:thisConst @:final public function GetPosition() : unreal.Float32;
  ...
  /**
    Animation play functions
          ...
          * Please use OverrideAnimationDatat for construction script. That will override AnimationData to be serialized
  **/
  @:ufunction @:final public function SetPlayRate(Rate : unreal.Float32) : Void;
  ...
  **/
  @:ufunction @:final public function OverrideAnimationData(InAnimToPlay : unreal.UAnimationAsset, bIsLooping : Bool = true, bIsPlaying : Bool = true, Position : unreal.Float32 = 0.000000, PlayRate : unreal.Float32 = 1.000000) : Void;
  ...
  **/
  @:ufunction @:final public function SetMorphTarget(MorphTargetName : unreal.FName, Value : unreal.Float32, bRemoveZeroWeight : Bool = true) : Void;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetMorphTarget(MorphTargetName : unreal.FName) : unreal.Float32;
  ...
  **/
  @:ufunction @:final public function SnapshotPose(Snapshot : unreal.PRef<unreal.FPoseSnapshot>) : Void;
  
  /**
    Get/Set the max distance scale of clothing mesh vertices
  **/
  @:ufunction @:final public function GetClothMaxDistanceScale() : unreal.Float32;
  @:ufunction @:final public function SetClothMaxDistanceScale(Scale : unreal.Float32) : Void;
  ...
  **/
  @:ufunction @:final public function ForceClothNextUpdateTeleport() : Void;
  ...
  **/
  @:ufunction @:final public function ForceClothNextUpdateTeleportAndReset() : Void;
  
  /**
    Stops simulating clothing, but does not show clothing ref pose. Keeps the last known simulation state
  **/
  @:ufunction @:final public function SuspendClothingSimulation() : Void;
  
  /**
    Resumes a previously suspended clothing simulation, teleporting the clothing on the next tick
  **/
  @:ufunction @:final public function ResumeClothingSimulation() : Void;
  
  /**
    Gets whether or not the clothing simulation is currently suspended
  **/
  @:ufunction @:final public function IsClothingSimulationSuspended() : Bool;
  
  /**
    Reset the teleport mode of a next update to 'Continuous'
  **/
  @:ufunction @:final public function ResetClothTeleportMode() : Void;
  ...
  **/
  @:ufunction @:final public function BindClothToMasterPoseComponent() : Void;
  ...
  /**
    ...
    undesirable.
  **/
  @:ufunction @:final public function UnbindClothFromMasterPoseComponent(bRestoreSimulationSpace : Bool = true) : Void;
  ...
  **/
  @:ufunction @:final public function SetUpdateAnimationInEditor(NewUpdateState : Bool) : Void;
  @:ufunction @:final public function SetDisableAnimCurves(bInDisableAnimCurves : Bool) : Void;
  @:ufunction @:thisConst @:final public function GetDisableAnimCurves() : Bool;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetTeleportRotationThreshold() : unreal.Float32;
  ...
  **/
  @:ufunction @:final public function SetTeleportRotationThreshold(Threshold : unreal.Float32) : Void;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetTeleportDistanceThreshold() : unreal.Float32;
  ...
  **/
  @:ufunction @:final public function SetTeleportDistanceThreshold(Threshold : unreal.Float32) : Void;
  ...
  **/
  @:ufunction public function SetBodyNotifyRigidBodyCollision(bNewNotifyRigidBodyCollision : Bool, @:opt("None") BoneName : unreal.FName) : Void;
  ...
  **/
  @:ufunction public function SetNotifyRigidBodyCollisionBelow(bNewNotifyRigidBodyCollision : Bool, @:opt("None") BoneName : unreal.FName, bIncludeSelf : Bool = true) : Void;
  ...
  **/
  @:ufunction @:final public function SetEnableBodyGravity(bEnableGravity : Bool, BoneName : unreal.FName) : Void;
  ...
  **/
  @:ufunction @:final public function IsBodyGravityEnabled(BoneName : unreal.FName) : Bool;
  ...
  **/
  @:ufunction @:final public function SetEnableGravityOnAllBodiesBelow(bEnableGravity : Bool, BoneName : unreal.FName, bIncludeSelf : Bool = true) : Void;
  ...
  **/
  @:ufunction @:thisConst @:final public function K2_GetClosestPointOnPhysicsAsset(WorldPosition : unreal.Const<unreal.PRef<unreal.FVector>>, ClosestWorldPosition : unreal.PRef<unreal.FVector>, Normal : unreal.PRef<unreal.FVector>, BoneName : unreal.PRef<unreal.FName>, Distance : unreal.Float32) : Bool;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetBoneMass(@:opt("None") BoneName : unreal.FName, bScaleMass : Bool = true) : unreal.Float32;
  
  /**
    Returns the center of mass of the skeletal mesh, instead of the root body's location
  **/
  @:ufunction @:thisConst @:final public function GetSkeletalCenterOfMass() : unreal.FVector;
  ...
  **/
  @:ufunction public function AddForceToAllBodiesBelow(Force : unreal.FVector, @:opt("None") BoneName : unreal.FName, bAccelChange : Bool = false, bIncludeSelf : Bool = true) : Void;
  ...
  /**
    ...
    @param bIncludeSelf If false, Force is only applied to bodies below but not given bone name.
  **/
  @:ufunction public function AddImpulseToAllBodiesBelow(Impulse : unreal.FVector, @:opt("None") BoneName : unreal.FName, bVelChange : Bool = false, bIncludeSelf : Bool = true) : Void;
  
  /**
    Set bSimulatePhysics to true for all bone bodies. Does not change the component bSimulatePhysics flag.
  **/
  @:ufunction @:final public function SetAllBodiesSimulatePhysics(bNewSimulate : Bool) : Void;
  ...
  **/
  @:ufunction @:final public function SetPhysicsBlendWeight(PhysicsBlendWeight : unreal.Float32) : Void;
  
  /**
    Disable physics blending of bones *
  **/
  @:ufunction @:final public function SetEnablePhysicsBlending(bNewBlendPhysics : Bool) : Void;
  
  /**
    Set all of the bones below passed in bone to be simulated
  **/
  @:ufunction @:final public function SetAllBodiesBelowSimulatePhysics(InBoneName : unreal.Const<unreal.PRef<unreal.FName>>, bNewSimulate : Bool, bIncludeSelf : Bool = true) : Void;
  
  /**
    Allows you to reset bodies Simulate state based on where bUsePhysics is set to true in the BodySetup.
  **/
  @:ufunction @:final public function ResetAllBodiesSimulatePhysics() : Void;
  @:ufunction @:final public function SetAllBodiesPhysicsBlendWeight(PhysicsBlendWeight : unreal.Float32, bSkipCustomPhysicsType : Bool = false) : Void;
  
  /**
    Set all of the bones below passed in bone to be simulated
  **/
  @:ufunction @:final public function SetAllBodiesBelowPhysicsBlendWeight(InBoneName : unreal.Const<unreal.PRef<unreal.FName>>, PhysicsBlendWeight : unreal.Float32, bSkipCustomPhysicsType : Bool = false, bIncludeSelf : Bool = true) : Void;
  
  /**
    Accumulate AddPhysicsBlendWeight to physics blendweight for all of the bones below passed in bone to be simulated
  **/
  @:ufunction @:final public function AccumulateAllBodiesBelowPhysicsBlendWeight(InBoneName : unreal.Const<unreal.PRef<unreal.FName>>, AddPhysicsBlendWeight : unreal.Float32, bSkipCustomPhysicsType : Bool = false) : Void;
  ...
  **/
  @:ufunction @:final public function SetAllMotorsAngularPositionDrive(bEnableSwingDrive : Bool, bEnableTwistDrive : Bool, bSkipCustomPhysicsType : Bool = false) : Void;
  ...
  **/
  @:ufunction @:final public function SetAllMotorsAngularVelocityDrive(bEnableSwingDrive : Bool, bEnableTwistDrive : Bool, bSkipCustomPhysicsType : Bool = false) : Void;
  
  /**
    Set Angular Drive motors params for all constraint instances
  **/
  @:ufunction @:final public function SetAllMotorsAngularDriveParams(InSpring : unreal.Float32, InDamping : unreal.Float32, InForceLimit : unreal.Float32, bSkipCustomPhysicsType : Bool = false) : Void;
  ...
  **/
  @:ufunction @:final public function SetConstraintProfile(JointName : unreal.FName, ProfileName : unreal.FName, bDefaultIfNotFound : Bool = false) : Void;
  ...
  **/
  @:ufunction @:final public function SetConstraintProfileForAll(ProfileName : unreal.FName, bDefaultIfNotFound : Bool = false) : Void;
  ...
  **/
  @:ufunction @:final public function FindConstraintBoneName(ConstraintIndex : unreal.Int32) : unreal.FName;
  ...
  **/
  @:ufunction @:final public function BreakConstraint(Impulse : unreal.FVector, HitLocation : unreal.FVector, InBoneName : unreal.FName) : Void;
  ...
  **/
  @:ufunction @:final public function SetAngularLimits(InBoneName : unreal.FName, Swing1LimitAngle : unreal.Float32, TwistLimitAngle : unreal.Float32, Swing2LimitAngle : unreal.Float32) : Void;
  ...
  **/
  @:ufunction @:final public function GetCurrentJointAngles(InBoneName : unreal.FName, Swing1Angle : unreal.Float32, TwistAngle : unreal.Float32, Swing2Angle : unreal.Float32) : Void;
