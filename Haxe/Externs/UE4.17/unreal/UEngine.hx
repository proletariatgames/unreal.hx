...
@:uextern @:uclass extern class UEngine extends unreal.UObject {
  ...
  **/
  @:uproperty public var DebugEditorMaterialName : unreal.FStringAssetReference;
  #if WITH_EDITORONLY_DATA
  ...
  **/
  @:uproperty public var ClothPaintMaterialWireframeName : unreal.FStringAssetReference;
  
  /**
    Name of the material used to render cloth in the clothing tools
  **/
  @:uproperty public var ClothPaintMaterialName : unreal.FStringAssetReference;
  ...
  **/
  ...
  /**
    @todo document
  **/
  @:uproperty public var DefaultBloomKernelTextureName : unreal.FStringAssetReference;
  ...
  **/
  @:uproperty public var AssetManagerClassName : unreal.FStringClassReference;
