...
@:uextern @:uclass extern class UKismetRenderingLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function CreateRenderTarget2D(WorldContextObject : unreal.UObject, Width : unreal.Int32 = 256, Height : unreal.Int32 = 256) : unreal.UTextureRenderTarget2D;
