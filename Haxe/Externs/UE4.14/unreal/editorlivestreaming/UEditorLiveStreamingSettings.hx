...
@:noClass @:uextern @:uclass extern class UEditorLiveStreamingSettings extends unreal.UObject {
  ...
  **/
  @:uproperty public var WebCamResolution : unreal.editorlivestreaming.EEditorLiveStreamingWebCamResolution;
  ...
  **/
  @:uproperty public var bEnableWebCam : Bool;
  ...
  **/
  @:uproperty public var bPrimaryMonitorOnly : Bool;
  ...
  **/
  @:uproperty public var ScreenScaling : unreal.Float32;
