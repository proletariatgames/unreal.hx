...
@:uextern @:uclass extern class UAudioComponent extends unreal.USceneComponent {
  ...
  **/
  @:ufunction @:final public function FadeIn(FadeInDuration : unreal.Float32, FadeVolumeLevel : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000) : Void;
  ...
  **/
  @:ufunction @:final public function AdjustAttenuation(InAttenuationSettings : unreal.Const<unreal.PRef<unreal.FAttenuationSettings>>) : Void;
  @:ufunction @:final public function BP_GetAttenuationSettingsToApply(OutAttenuationSettings : unreal.PRef<unreal.FAttenuationSettings>) : Bool;
