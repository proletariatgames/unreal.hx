...
@:uextern @:uclass extern class UWheeledVehicleMovementComponent extends unreal.UMovementComponent implements unreal.IRVOAvoidanceInterface {
  
  /**
    Rate at which input steering can rise and fall
  **/
  @:uproperty private var SteeringInputRate : unreal.FVehicleInputRate;
  
  /**
    Rate at which input handbrake can rise and fall
  **/
  @:uproperty private var HandbrakeInputRate : unreal.FVehicleInputRate;
  
  /**
    Rate at which input brake can rise and fall
  **/
  @:uproperty private var BrakeInputRate : unreal.FVehicleInputRate;
  
  /**
    Rate at which input throttle can rise and fall
  **/
  @:uproperty private var ThrottleInputRate : unreal.FVehicleInputRate;
  ...
  **/
  @:uproperty private var ReplicatedState : unreal.FReplicatedVehicleState;
  ...
  **/
  @:uproperty public var Wheels : unreal.TArray<unreal.UVehicleWheel>;
  ...
  **/
  ...
  /**
    Wheels to create
  **/
  @:uproperty public var WheelSetups : unreal.TArray<unreal.FWheelSetup>;
