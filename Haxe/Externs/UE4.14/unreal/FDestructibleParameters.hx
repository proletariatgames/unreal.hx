...
@:noCopy @:noEquals @:uextern @:ustruct extern class FDestructibleParameters {
  ...
  **/
  @:uproperty public var Flags : unreal.FDestructibleParametersFlag;
  ...
  **/
  @:uproperty public var DepthParameters : unreal.TArray<unreal.FDestructibleDepthParameters>;
  
  /**
    Special hierarchy depths for various behaviors.
  **/
  @:uproperty public var SpecialHierarchyDepths : unreal.FDestructibleSpecialHierarchyDepths;
  
  /**
    Parameters that are less-often used.  See DestructibleAdvancedParameters.
  **/
  @:uproperty public var AdvancedParameters : unreal.FDestructibleAdvancedParameters;
  
  /**
    Parameters that pertain to chunk debris-level settings.  See DestructibleDebrisParameters.
  **/
  @:uproperty public var DebrisParameters : unreal.FDestructibleDebrisParameters;
  
  /**
    Parameters that pertain to chunk damage.  See DestructibleDamageParameters.
  **/
  @:uproperty public var DamageParameters : unreal.FDestructibleDamageParameters;
