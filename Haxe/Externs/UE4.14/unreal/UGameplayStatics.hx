...
@:uextern @:uclass extern class UGameplayStatics extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction static public function BeginSpawningActorFromBlueprint(WorldContextObject : unreal.UObject, Blueprint : unreal.Const<unreal.UBlueprint>, SpawnTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, bNoCollisionFail : Bool) : unreal.AActor;
  @:ufunction static public function BeginSpawningActorFromClass(WorldContextObject : unreal.UObject, ActorClass : unreal.TSubclassOf<unreal.AActor>, SpawnTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, bNoCollisionFail : Bool = false, Owner : unreal.AActor) : unreal.AActor;
  
  /**
    Spawns an instance of an actor class, but does not automatically run its construction script.
  **/
  @:ufunction static public function BeginDeferredActorSpawnFromClass(WorldContextObject : unreal.UObject, ActorClass : unreal.TSubclassOf<unreal.AActor>, SpawnTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, CollisionHandlingOverride : unreal.ESpawnActorCollisionHandlingMethod = Undefined, Owner : unreal.AActor) : unreal.AActor;
  ...
  **/
  ...
  /**
    ...
    @param DamageTypeClass - Class that describes the damage that was done.
  **/
  @:ufunction static public function ApplyDamage(DamagedActor : unreal.AActor, BaseDamage : unreal.Float32, EventInstigator : unreal.AController, DamageCauser : unreal.AActor, DamageTypeClass : unreal.TSubclassOf<unreal.UDamageType>) : Void;
  ...
  **/
  ...
  /**
    ...
    @param bAutoDestroy - Whether the component will automatically be destroyed when the particle system completes playing or whether it can be reactivated
  **/
  @:ufunction static public function SpawnEmitterAttached(EmitterTemplate : unreal.UParticleSystem, AttachToComponent : unreal.USceneComponent, AttachPointName : unreal.FName = None, Location : unreal.FVector, Rotation : unreal.FRotator, LocationType : unreal.EAttachLocation = KeepRelativeOffset, bAutoDestroy : Bool = true) : unreal.UParticleSystemComponent;
  ...
  **/
  ...
  /**
    ...
    @return An audio component to manipulate the spawned sound
  **/
  @:ufunction static public function SpawnSoundAtLocation(WorldContextObject : unreal.Const<unreal.UObject>, Sound : unreal.USoundBase, Location : unreal.FVector, Rotation : unreal.FRotator, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, AttenuationSettings : unreal.USoundAttenuation, ConcurrencySettings : unreal.USoundConcurrency) : unreal.UAudioComponent;
  ...
  /**
    ...
    @return An audio component to manipulate the spawned sound
  **/
  @:ufunction static public function SpawnSoundAttached(Sound : unreal.USoundBase, AttachToComponent : unreal.USceneComponent, AttachPointName : unreal.FName = None, Location : unreal.FVector, Rotation : unreal.FRotator, LocationType : unreal.EAttachLocation = KeepRelativeOffset, bStopWhenAttachedToDestroyed : Bool = false, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, AttenuationSettings : unreal.USoundAttenuation, ConcurrencySettings : unreal.USoundConcurrency) : unreal.UAudioComponent;
  ...
  **/
  ...
  /**
    ...
    * Not Replicated.
    ...
    @return An audio component to manipulate the spawned sound
  **/
  @:ufunction static public function SpawnDialogue2D(WorldContextObject : unreal.Const<unreal.UObject>, Dialogue : unreal.UDialogueWave, Context : unreal.Const<unreal.PRef<unreal.FDialogueContext>>, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000) : unreal.UAudioComponent;
  ...
  **/
  @:ufunction static public function SpawnDialogueAtLocation(WorldContextObject : unreal.Const<unreal.UObject>, Dialogue : unreal.UDialogueWave, Context : unreal.Const<unreal.PRef<unreal.FDialogueContext>>, Location : unreal.FVector, Rotation : unreal.FRotator, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, AttenuationSettings : unreal.USoundAttenuation) : unreal.UAudioComponent;
  ...
  /**
    ...
    @return Audio Component to manipulate the playing dialogue with
  **/
  @:ufunction static public function SpawnDialogueAttached(Dialogue : unreal.UDialogueWave, Context : unreal.Const<unreal.PRef<unreal.FDialogueContext>>, AttachToComponent : unreal.USceneComponent, AttachPointName : unreal.FName = None, Location : unreal.FVector, Rotation : unreal.FRotator, LocationType : unreal.EAttachLocation = KeepRelativeOffset, bStopWhenAttachedToDestroyed : Bool = false, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, AttenuationSettings : unreal.USoundAttenuation) : unreal.UAudioComponent;
  ...
  **/
  ...
  /**
    ...
    @param LifeSpan - destroy decal component after time runs out (0 = infinite)
  **/
  @:ufunction static public function SpawnDecalAttached(DecalMaterial : unreal.UMaterialInterface, DecalSize : unreal.FVector, AttachToComponent : unreal.USceneComponent, AttachPointName : unreal.FName = None, Location : unreal.FVector, Rotation : unreal.FRotator, LocationType : unreal.EAttachLocation = KeepRelativeOffset, LifeSpan : unreal.Float32 = 0.000000) : unreal.UDecalComponent;
