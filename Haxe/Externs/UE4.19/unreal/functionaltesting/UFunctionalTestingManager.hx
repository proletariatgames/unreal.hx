...
@:uextern @:uclass extern class UFunctionalTestingManager extends unreal.UBlueprintFunctionLibrary {
  @:uproperty public var OnTestsBegin : unreal.functionaltesting.FFunctionalTestEventSignature;
  @:uproperty public var OnTestsComplete : unreal.functionaltesting.FFunctionalTestEventSignature;
  @:uproperty public var OnSetupTests : unreal.functionaltesting.FFunctionalTestEventSignature;
