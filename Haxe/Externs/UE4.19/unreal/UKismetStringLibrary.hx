...
@:uextern @:uclass extern class UKismetStringLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function ParseIntoArray(SourceString : unreal.FString, @:opt(" ") ?Delimiter : unreal.FString, CullEmptyStrings : Bool = true) : unreal.TArray<unreal.FString>;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function JoinStringArray(SourceArray : unreal.Const<unreal.PRef<unreal.TArray<unreal.FString>>>, @:opt(" ") ?Separator : unreal.FString) : unreal.FString;
