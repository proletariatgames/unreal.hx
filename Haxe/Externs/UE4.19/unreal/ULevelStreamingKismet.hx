...
@:uextern @:uclass extern class ULevelStreamingKismet extends unreal.ULevelStreaming {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function LoadLevelInstance(WorldContextObject : unreal.UObject, LevelName : unreal.FString, Location : unreal.FVector, Rotation : unreal.FRotator, bOutSuccess : Bool) : unreal.ULevelStreamingKismet;
