...
@:uextern @:uclass extern class UGameUserSettings extends unreal.UObject {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function ConfirmVideoMode() : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetOverallScalabilityLevel() : unreal.Int32;
