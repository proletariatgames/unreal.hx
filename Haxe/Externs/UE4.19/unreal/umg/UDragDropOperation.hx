...
@:uextern @:uclass extern class UDragDropOperation extends unreal.UObject {
  @:uproperty public var OnDragged : unreal.umg.FOnDragDropMulticast;
  @:uproperty public var OnDragCancelled : unreal.umg.FOnDragDropMulticast;
  @:uproperty public var OnDrop : unreal.umg.FOnDragDropMulticast;
