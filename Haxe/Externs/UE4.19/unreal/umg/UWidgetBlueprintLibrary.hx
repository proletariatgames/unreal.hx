...
@:uextern @:uclass extern class UWidgetBlueprintLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetInputMode_UIOnlyEx(PlayerController : unreal.APlayerController, InWidgetToFocus : unreal.umg.UWidget, @:opt("DoNotLock") InMouseLockMode : unreal.EMouseLockMode) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetInputMode_GameAndUIEx(PlayerController : unreal.APlayerController, InWidgetToFocus : unreal.umg.UWidget, @:opt("DoNotLock") InMouseLockMode : unreal.EMouseLockMode, bHideCursorDuringCapture : Bool = true) : Void;
