...
@:uextern @:uclass extern class UCanvasPanelSlot extends unreal.umg.UPanelSlot {
  ...
  **/
  @:uproperty public var bAutoSize : Bool;
  
  /**
    The anchoring information for the slot
  **/
  @:uproperty public var LayoutData : unreal.umg.FAnchorData;
  ...
  **/
  ...
  /**
    Sets the anchors on the slot
  **/
  @:ufunction @:final public function SetMinimum(InMinimumAnchors : unreal.FVector2D) : Void;
  
  /**
    Sets the anchors on the slot
  **/
  @:ufunction @:final public function SetMaximum(InMaximumAnchors : unreal.FVector2D) : Void;
