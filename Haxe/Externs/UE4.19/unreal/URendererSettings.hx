...
@:uextern @:uclass extern class URendererSettings extends unreal.UDeveloperSettings {
  ...
  **/
  ...
  /**
    Enables debug canvases to be rendered in HMD layers
  **/
  @:uproperty public var bDebugCanvasInLayer : Bool;
  ...
  **/
  ...
  /**
    Limits Cascade GPU Particle simulations to applying local vector fields.  Global vector fields are not applied.
  **/
  @:uproperty public var bGPUParticlesLocalVFOnly : Bool;
  ...
  **/
  ...
  /**
    Which units to use for spot lights
  **/
  @:uproperty public var DefaultSpotLightUnits : unreal.ELightUnits;
  
  /**
    Which units to use for point lights
  **/
  @:uproperty public var DefaultPointLightUnits : unreal.ELightUnits;
  ...
  **/
  ...
  /**
    Whether alpha channel should be supported in post processing chain. Still experimental: works only with Temporal AA, Motion Blur, Circle Depth Of Field. This option also force disable the separate translucency.
  **/
  @:uproperty public var bEnableAlphaChannelInPostProcessing : Bool;
