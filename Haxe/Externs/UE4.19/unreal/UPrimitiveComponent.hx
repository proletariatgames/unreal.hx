...
@:uextern @:uclass extern class UPrimitiveComponent extends unreal.USceneComponent implements unreal.INavRelevantInterface {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function AddTorqueInRadians(Torque : unreal.FVector, @:opt("None") BoneName : unreal.FName, bAccelChange : Bool = false) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetPhysicsAngularVelocityInRadians(NewAngVel : unreal.FVector, bAddToCurrent : Bool = false, @:opt("None") BoneName : unreal.FName) : Void;
  ...
  **/
  ...
  /**
    ...
    @param BoneName                 If a SkeletalMeshComponent, name of body to get velocity of. 'None' indicates root body.
  **/
  @:ufunction(BlueprintCallable) @:final public function GetPhysicsAngularVelocityInDegrees(@:opt("None") BoneName : unreal.FName) : unreal.FVector;
  
  /**
    Get the angular velocity of a single body, in radians per second.
    @param BoneName                 If a SkeletalMeshComponent, name of body to get velocity of. 'None' indicates root body.
  **/
  @:ufunction(BlueprintCallable) @:final public function GetPhysicsAngularVelocityInRadians(@:opt("None") BoneName : unreal.FName) : unreal.FVector;
