...
@:uextern @:uclass extern class UKismetSystemLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  // proletariat: UnrealHx doesn't support the CustomThunk required for this function, so
  // we manually comment out this function in the generated extern.
  ...
  **/
  ...
  /**
    ...
    @param       Duration                The display duration (if Print to Screen is True). Using negative number will result in loading the duration time from the config.
  **/
  @:ufunction(BlueprintCallable) static public function PrintText(WorldContextObject : unreal.UObject, InText : unreal.Const<unreal.FText> = "Hello", bPrintToScreen : Bool = true, bPrintToLog : Bool = true, @:opt("(R=0.000000,G=0.660000,B=1.000000,A=1.000000)") TextColor : unreal.FLinearColor, Duration : unreal.Float32 = 2.000000) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function ExecuteConsoleCommand(WorldContextObject : unreal.UObject, Command : unreal.FString, SpecificPlayer : unreal.APlayerController) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetConsoleVariableFloatValue(WorldContextObject : unreal.UObject, VariableName : unreal.FString) : unreal.Float32;
  ...
  /**
    ...
    @return      The value if found, 0 otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function GetConsoleVariableIntValue(WorldContextObject : unreal.UObject, VariableName : unreal.FString) : unreal.Int32;

  /**
    Exit the current game
    @param       SpecificPlayer  The specific player to quit the game. If not specified, player 0 will quit.
  **/
  @:ufunction(BlueprintCallable) static public function QuitGame(WorldContextObject : unreal.UObject, SpecificPlayer : unreal.APlayerController, QuitPreference : unreal.EQuitPreference) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugString(WorldContextObject : unreal.UObject, TextLocation : unreal.Const<unreal.FVector>, Text : unreal.FString, TestBaseActor : unreal.AActor, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") TextColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000) : Void;
