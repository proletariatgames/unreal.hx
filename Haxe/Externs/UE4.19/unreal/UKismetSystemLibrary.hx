...
@:uextern @:uclass extern class UKismetSystemLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  /**
    ...
    @param       Duration                The display duration (if Print to Screen is True). Using negative number will result in loading the duration time from the config.
  **/
  @:ufunction(BlueprintCallable) static public function PrintText(WorldContextObject : unreal.UObject, @:opt("Hello") ?InText : unreal.Const<unreal.FText> , bPrintToScreen : Bool = true, bPrintToLog : Bool = true, @:opt("(R=0.000000,G=0.660000,B=1.000000,A=1.000000)") TextColor : unreal.FLinearColor, Duration : unreal.Float32 = 2.000000) : Void;
