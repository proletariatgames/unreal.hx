...
@:hasCopy
extern class FVector_NetQuantize10_Extra {
  public function new();
  @:uname('.ctor') public static function create() : FVector_NetQuantize10;
  @:uname('.ctor') public static function createFromVector(Vec:Const<PRef<FVector>>) : FVector_NetQuantize10;
