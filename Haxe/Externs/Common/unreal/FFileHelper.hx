...
@:noEquals @:noCopy @:uextern extern class FFileHelper
{
	...
	*/
	static function LoadFileToArray( Result:PRef<TArray<UInt8>> , Filename:TCharStar, Flags:UInt32 = 0 ):Bool;
	 ...
	 */
	static function LoadFileToString( Result:PRef<FString>, Filename:TCharStar ):Bool;
	 ...
	 * @param VerifyFlags  Flags controlling the hash verification behavior ( see EHashOptions )
	 */
	static function LoadFileToStringArray( Result:PRef<TArray<FString>>, Filename:TCharStar ):Bool;
}
