...
@:uextern @:uclass extern class UPhysicsConstraintComponent extends unreal.USceneComponent {
  ...
  **/
  @:ufunction @:final public function SetLinearDriveParams(InSpring : unreal.Float32, InDamping : unreal.Float32, InForceLimit : unreal.Float32) : Void;
  ...
  **/
  ...
  /**
    Sets the drive params for the angular drive.
        ...
        @param InForceLimit     Max force applied by the drive
  **/
  @:ufunction @:final public function SetAngularDriveParams(InSpring : unreal.Float32, InDamping : unreal.Float32, InForceLimit : unreal.Float32) : Void;
