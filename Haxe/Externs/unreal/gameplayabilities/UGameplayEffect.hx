...
@:uextern @:uclass extern class UGameplayEffect extends unreal.UObject implements unreal.gameplaytags.IGameplayTagAssetInterface {
  ...
  **/
  @:uproperty public var ClearTagsContainer : unreal.gameplaytags.FGameplayTagContainer;
  ...
  **/
  @:uproperty public var OwnedTagsContainer : unreal.gameplaytags.FGameplayTagContainer;
  ...
  **/
  @:uproperty public var GameplayEffectTags : unreal.gameplaytags.FGameplayTagContainer;
  ...
  **/
  @:uproperty public var TargetEffects : unreal.TArray<unreal.gameplayabilities.UGameplayEffect>;
  
  /**
    other gameplay effects that will be applied to the target of this effect if this effect applies
  **/
  @:uproperty public var TargetEffectClasses : unreal.TArray<unreal.TSubclassOf<unreal.gameplayabilities.UGameplayEffect>>;
  ...
  **/
  @:uproperty public var ShowAllProperties : Bool;
  
  /**
    Template to derive starting values and editing customization from
  **/
  @:uproperty public var Template : unreal.gameplayabilities.UGameplayEffectTemplate;
