...
@:uextern @:uclass extern class UCapsuleComponent extends unreal.UShapeComponent {
  ...
  **/
  @:ufunction @:final public function SetCapsuleSize(InRadius : unreal.Float32, InHalfHeight : unreal.Float32, bUpdateOverlaps : Bool = true) : Void;
  ...
  /**
    ...
    @param       bUpdateOverlaps: if true and this shape is registered and collides, updates touching array for owner actor.
  **/
  @:ufunction @:final public function SetCapsuleRadius(Radius : unreal.Float32, bUpdateOverlaps : Bool = true) : Void;
  ...
  /**
    ...
    @param       bUpdateOverlaps: if true and this shape is registered and collides, updates touching array for owner actor.
  **/
  @:ufunction @:final public function SetCapsuleHalfHeight(HalfHeight : unreal.Float32, bUpdateOverlaps : Bool = true) : Void;
  
  /**
    Returns the capsule radius scaled by the component scale.
    @return The capsule radius scaled by the component scale.
  **/
  @:ufunction @:thisConst @:final public function GetScaledCapsuleRadius() : unreal.Float32;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetScaledCapsuleHalfHeight() : unreal.Float32;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetScaledCapsuleHalfHeight_WithoutHemisphere() : unreal.Float32;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetScaledCapsuleSize(OutRadius : unreal.Float32, OutHalfHeight : unreal.Float32) : Void;
  ...
  /**
    ...
    @return The capsule radius and half-height scaled by the component scale.
  **/
  @:ufunction @:thisConst @:final public function GetScaledCapsuleSize_WithoutHemisphere(OutRadius : unreal.Float32, OutHalfHeightWithoutHemisphere : unreal.Float32) : Void;
  
  /**
    Returns the capsule radius, ignoring component scaling.
    @return the capsule radius, ignoring component scaling.
  **/
  @:ufunction @:thisConst @:final public function GetUnscaledCapsuleRadius() : unreal.Float32;
  
  /**
    Returns the capsule half-height, ignoring component scaling. This includes the hemisphere end cap.
    @return The capsule radius, ignoring component scaling.
  **/
  @:ufunction @:thisConst @:final public function GetUnscaledCapsuleHalfHeight() : unreal.Float32;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetUnscaledCapsuleHalfHeight_WithoutHemisphere() : unreal.Float32;
  ...
  /**
    ...
    @return The capsule radius and half-height scaled by the component scale.
  **/
  @:ufunction @:thisConst @:final public function GetUnscaledCapsuleSize(OutRadius : unreal.Float32, OutHalfHeight : unreal.Float32) : Void;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetUnscaledCapsuleSize_WithoutHemisphere(OutRadius : unreal.Float32, OutHalfHeightWithoutHemisphere : unreal.Float32) : Void;
