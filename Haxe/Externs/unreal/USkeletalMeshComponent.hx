...
@:uextern @:uclass extern class USkeletalMeshComponent extends unreal.USkinnedMeshComponent implements unreal.IInterface_CollisionDataProvider {
  ...
  **/
  @:uproperty public var bAutonomousTickPose : Bool;
  ...
  **/
  @:ufunction public function SetBodyNotifyRigidBodyCollision(bNewNotifyRigidBodyCollision : Bool, BoneName : unreal.FName = None) : Void;
  ...
  **/
  @:ufunction public function SetNotifyRigidBodyCollisionBelow(bNewNotifyRigidBodyCollision : Bool, BoneName : unreal.FName = None, bIncludeSelf : Bool = true) : Void;
  ...
  **/
  @:ufunction @:thisConst @:final public function GetBoneMass(BoneName : unreal.FName = None, bScaleMass : Bool = true) : unreal.Float32;
  ...
  **/
  @:ufunction public function AddForceToAllBodiesBelow(Force : unreal.FVector, BoneName : unreal.FName = None, bAccelChange : Bool = false, bIncludeSelf : Bool = true) : Void;
  ...
  /**
    ...
    @param bIncludeSelf If false, Force is only applied to bodies below but not given bone name.
  **/
  @:ufunction public function AddImpulseToAllBodiesBelow(Impulse : unreal.FVector, BoneName : unreal.FName = None, bVelChange : Bool = false, bIncludeSelf : Bool = true) : Void;
