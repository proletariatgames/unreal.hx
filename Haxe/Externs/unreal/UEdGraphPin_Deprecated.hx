...
@:uextern extern class UEdGraphPin_Deprecated extends unreal.UObject {
  ...
  **/
  public var ReferencePassThroughConnection : unreal.UEdGraphPin_Deprecated;
  
  /**
    The pin that was split and generated this pin
  **/
  public var ParentPin : unreal.UEdGraphPin_Deprecated;
  
  /**
    The pins created when a pin is split and hidden
  **/
  public var SubPins : unreal.TArray<unreal.UEdGraphPin_Deprecated>;
  
  /**
    Set of pins that we are linked to
  **/
  public var LinkedTo : unreal.TArray<unreal.UEdGraphPin_Deprecated>;
