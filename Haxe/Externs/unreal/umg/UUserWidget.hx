...
@:uextern @:uclass extern class UUserWidget extends unreal.umg.UWidget implements unreal.umg.INamedSlotInterface {
  ...
  **/
  ...
  @:ufunction public function OnControllerButtonPressed(MyGeometry : unreal.slatecore.FGeometry, ControllerEvent : unreal.slatecore.FControllerEvent) : unreal.umg.FEventReply;
  @:ufunction public function OnControllerButtonReleased(MyGeometry : unreal.slatecore.FGeometry, ControllerEvent : unreal.slatecore.FControllerEvent) : unreal.umg.FEventReply;
  @:ufunction public function OnControllerAnalogValueChanged(MyGeometry : unreal.slatecore.FGeometry, ControllerEvent : unreal.slatecore.FControllerEvent) : unreal.umg.FEventReply;
  ...
  **/
  @:ufunction @:final public function PlayAnimation(InAnimation : unreal.Const<unreal.umg.UWidgetAnimation>, StartAtTime : unreal.Float32 = 0.000000, NumLoopsToPlay : unreal.Int32 = 1, PlayMode : unreal.umg.EUMGSequencePlayMode = Forward, PlaybackSpeed : unreal.Float32 = 1.000000) : Void;
  ...
  /**
    ...
    @param PlayMode Specifies the playback mode
  **/
  @:ufunction @:final public function PlayAnimationTo(InAnimation : unreal.Const<unreal.umg.UWidgetAnimation>, StartAtTime : unreal.Float32 = 0.000000, EndAtTime : unreal.Float32 = 0.000000, NumLoopsToPlay : unreal.Int32 = 1, PlayMode : unreal.umg.EUMGSequencePlayMode = Forward, PlaybackSpeed : unreal.Float32 = 1.000000) : Void;
  ...
  **/
  @:deprecated @:uproperty public var bUseDesiredSizeAtDesignTime_DEPRECATED : Bool;
  
  /**
    A flag that determines if the design time size is used for previewing the widget in the designer.
  **/
  @:deprecated @:uproperty public var bUseDesignTimeSize_DEPRECATED : Bool;
  ...
  **/
  @:uproperty public var NamedSlotBindings : unreal.TArray<unreal.umg.FNamedSlotBinding>;
