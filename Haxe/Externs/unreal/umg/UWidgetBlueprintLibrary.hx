...
@:uextern @:uclass extern class UWidgetBlueprintLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction static public function SetInputMode_UIOnlyEx(Target : unreal.APlayerController, InWidgetToFocus : unreal.umg.UWidget, InMouseLockMode : unreal.EMouseLockMode = DoNotLock) : Void;
  ...
  **/
  @:ufunction static public function SetInputMode_GameAndUIEx(Target : unreal.APlayerController, InWidgetToFocus : unreal.umg.UWidget, InMouseLockMode : unreal.EMouseLockMode = DoNotLock, bHideCursorDuringCapture : Bool = true) : Void;
  ...
  **/
  ...
  @:ufunction static public function GetInputEventFromControllerEvent(Event : unreal.Const<unreal.PRef<unreal.slatecore.FControllerEvent>>) : unreal.slatecore.FInputEvent;
