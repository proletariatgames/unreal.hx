...
@:uextern extern class UWidgetBlueprintLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  static public function SetInputMode_UIOnlyEx(Target : unreal.APlayerController, InWidgetToFocus : unreal.umg.UWidget, InMouseLockMode : unreal.EMouseLockMode) : Void;
  ...
  **/
  static public function SetInputMode_GameAndUIEx(Target : unreal.APlayerController, InWidgetToFocus : unreal.umg.UWidget, InMouseLockMode : unreal.EMouseLockMode, bHideCursorDuringCapture : Bool) : Void;
  ...
  **/
  static public function GetSafeZonePadding(WorldContextObject : unreal.UObject, SafePadding : unreal.PRef<unreal.FVector2D>, SafePaddingScale : unreal.PRef<unreal.FVector2D>, SpillOverPadding : unreal.PRef<unreal.FVector2D>) : Void;
