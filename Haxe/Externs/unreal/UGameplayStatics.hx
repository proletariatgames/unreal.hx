...
@:uextern extern class UGameplayStatics extends unreal.UBlueprintFunctionLibrary {
  ...
  /**
    --- Create Object
  **/
  static public function SpawnObject(ObjectClass : unreal.TSubclassOf<unreal.UObject>, Outer : unreal.UObject) : unreal.UObject;
  
  /**
    Spawns an instance of a blueprint, but does not automatically run its construction script.
  **/
  static public function BeginSpawningActorFromBlueprint(WorldContextObject : unreal.UObject, Blueprint : unreal.Const<unreal.UBlueprint>, SpawnTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, bNoCollisionFail : Bool) : unreal.AActor;
  static public function BeginSpawningActorFromClass(WorldContextObject : unreal.UObject, ActorClass : unreal.TSubclassOf<unreal.AActor>, SpawnTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, bNoCollisionFail : Bool, Owner : unreal.AActor) : unreal.AActor;
  
  /**
    Spawns an instance of an actor class, but does not automatically run its construction script.
  **/
  static public function BeginDeferredActorSpawnFromClass(WorldContextObject : unreal.UObject, ActorClass : unreal.TSubclassOf<unreal.AActor>, SpawnTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, CollisionHandlingOverride : unreal.ESpawnActorCollisionHandlingMethod, Owner : unreal.AActor) : unreal.AActor;
  
  /**
    'Finish' spawning an actor.  This will run the construction script.
  **/
  static public function FinishSpawningActor(Actor : unreal.AActor, SpawnTransform : unreal.Const<unreal.PRef<unreal.FTransform>>) : unreal.AActor;
  
  /**
    Find the average location (centroid) of an array of Actors
  **/
  static public function GetActorArrayAverageLocation(Actors : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>) : unreal.FVector;
  
  /**
    Bind the bounds of an array of Actors
  **/
  static public function GetActorArrayBounds(Actors : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, bOnlyCollidingComponents : Bool, Center : unreal.PRef<unreal.FVector>, BoxExtent : unreal.PRef<unreal.FVector>) : Void;
  ...
  **/
  static public function CancelAsyncLoading() : Void;
  ...
  **/
  ...
  /**
    ...
    @param DamageTypeClass - Class that describes the damage that was done.
  **/
  static public function ApplyDamage(DamagedActor : unreal.AActor, BaseDamage : unreal.Float32, EventInstigator : unreal.AController, DamageCauser : unreal.AActor, DamageTypeClass : unreal.TSubclassOf<unreal.UDamageType>) : Void;
  ...
  **/
  ...
  /**
    ...
    @param bAutoDestroy - Whether the component will automatically be destroyed when the particle system completes playing or whether it can be reactivated
  **/
  static public function SpawnEmitterAttached(EmitterTemplate : unreal.UParticleSystem, AttachToComponent : unreal.USceneComponent, AttachPointName : unreal.FName, Location : unreal.FVector, Rotation : unreal.FRotator, LocationType : unreal.EAttachLocation, bAutoDestroy : Bool) : unreal.UParticleSystemComponent;
  ...
  **/
  static public function CreateSaveGameObject(SaveGameClass : unreal.TSubclassOf<unreal.USaveGame>) : unreal.USaveGame;
  ...
  /**
    ...
    @return                                         New SaveGame object to write data to
  **/
  static public function CreateSaveGameObjectFromBlueprint(SaveGameBlueprint : unreal.UBlueprint) : unreal.USaveGame;
  ...
  **/
  static public function SaveGameToSlot(SaveGameObject : unreal.USaveGame, SlotName : unreal.FString, UserIndex : unreal.Int32) : Bool;
  ...
  **/
  static public function EnableLiveStreaming(Enable : Bool) : Void;
  ...
  **/
  static public function GetPlatformName() : unreal.FString;
  ...
  **/
  static public function GetKeyValue(Pair : unreal.FString, Key : unreal.PRef<unreal.FString>, Value : unreal.PRef<unreal.FString>) : Void;
  ...
  **/
  static public function ParseOption(Options : unreal.FString, Key : unreal.FString) : unreal.FString;
  ...
  **/
  static public function HasOption(Options : unreal.FString, InKey : unreal.FString) : Bool;
  ...
  **/
  static public function GetIntOption(Options : unreal.FString, Key : unreal.FString, DefaultValue : unreal.Int32) : unreal.Int32;
