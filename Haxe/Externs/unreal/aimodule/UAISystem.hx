...
@:uextern @:uclass extern class UAISystem extends unreal.UAISystemBase {
  ...
  **/
  ...
  @:uproperty private var HotSpotManagerClassName : unreal.FStringClassReference;
  @:uproperty private var PerceptionSystemClassName : unreal.FStringClassReference;
