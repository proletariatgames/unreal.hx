...
@:uextern extern class USCS_Node extends unreal.UObject {
  ...
  **/
  @:deprecated public var bVariableNameAutoGenerated_DEPRECATED : Bool;
  
  /**
    (DEPRECATED) If this is a native component, this is the name of the UActorComponent
  **/
  @:deprecated public var NativeComponentName_DEPRECATED : unreal.FName;
  
  /**
    (DEPRECATED) Indicates if this is a native component or not
  **/
  @:deprecated public var bIsNative_DEPRECATED : Bool;
  
  /**
    (DEPRECATED)
  **/
  @:deprecated public var bIsFalseRoot_DEPRECATED : Bool;
