...
@:uextern @:uclass extern class UParticleSystemComponent extends unreal.UPrimitiveComponent {
  ...
  **/
  @:ufunction @:final public function SetAutoAttachParams(Parent : unreal.USceneComponent, SocketName : unreal.FName = None, LocationType : unreal.EAttachLocation = KeepRelativeOffset) : Void;
