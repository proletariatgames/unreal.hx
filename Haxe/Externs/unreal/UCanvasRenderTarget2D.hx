...
@:uextern extern class UCanvasRenderTarget2D extends unreal.UTextureRenderTarget2D {
  ...
  **/
  static public function CreateCanvasRenderTarget2D(WorldContextObject : unreal.UObject, CanvasRenderTarget2DClass : unreal.TSubclassOf<unreal.UCanvasRenderTarget2D>, Width : unreal.Int32, Height : unreal.Int32) : unreal.UCanvasRenderTarget2D;
  ...
  /**
    ...
    @param       Height                          Height of the render target.
  **/
  public function ReceiveUpdate(Canvas : unreal.UCanvas, Width : unreal.Int32, Height : unreal.Int32) : Void;
  ...
  **/
  @:final public function GetSize(Width : unreal.Int32, Height : unreal.Int32) : Void;
