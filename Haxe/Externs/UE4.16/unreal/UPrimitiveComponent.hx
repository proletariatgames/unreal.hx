...
@:uextern @:uclass extern class UPrimitiveComponent extends unreal.USceneComponent implements unreal.INavRelevantInterface {
  ...
  **/
  @:ufunction @:thisConst public function GetMaterialFromCollisionFaceIndex(FaceIndex : unreal.Int32) : unreal.UMaterialInterface;
  ...
  **/
  @:ufunction @:final public function GetCenterOfMass(@:opt("None") BoneName : unreal.FName) : unreal.FVector;
