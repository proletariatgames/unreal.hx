...
@:uextern @:uclass extern class UPaperImporterSettings extends unreal.UObject {
  ...
  **/
  @:uproperty private var LitDefaultOpaqueMaterialName : unreal.FStringAssetReference;
  ...
  **/
  @:uproperty private var LitDefaultTranslucentMaterialName : unreal.FStringAssetReference;
  ...
  **/
  @:uproperty private var LitDefaultMaskedMaterialName : unreal.FStringAssetReference;
  
  /**
    The unlit default opaque material for newly created sprites
  **/
  @:uproperty private var UnlitDefaultOpaqueMaterialName : unreal.FStringAssetReference;
  ...
  **/
  @:uproperty private var UnlitDefaultTranslucentMaterialName : unreal.FStringAssetReference;
  ...
  **/
  @:uproperty private var UnlitDefaultMaskedMaterialName : unreal.FStringAssetReference;
