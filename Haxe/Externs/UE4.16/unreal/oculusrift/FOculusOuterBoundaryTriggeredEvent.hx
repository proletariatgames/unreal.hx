...
@:umodule("OculusRift")
@:uname("UOculusRiftBoundaryComponent.FOculusOuterBoundaryTriggeredEvent")
typedef FOculusOuterBoundaryTriggeredEvent = unreal.DynamicMulticastDelegate<FOculusOuterBoundaryTriggeredEvent, unreal.Const<unreal.PRef<unreal.TArray<unreal.oculusrift.FBoundaryTestResult>>>->Void>;