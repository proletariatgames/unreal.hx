...
@:uextern @:uclass extern class UGameUserSettings extends unreal.UObject {
  ...
  **/
  @:ufunction public function GetRecommendedResolutionScale() : unreal.Float32;
  ...
  **/
  @:ufunction @:thisConst public function SupportsHDRDisplayOutput() : Bool;
  
  /**
    Enables or disables HDR display output. Can be called again to change the desired nit level
  **/
  @:ufunction @:final public function EnableHDRDisplayOutput(bEnable : Bool, DisplayNits : unreal.Int32 = 1000) : Void;
  
  /**
    Returns 0 if HDR isn't supported or is turned off
  **/
  @:ufunction @:thisConst @:final public function GetCurrentHDRDisplayNits() : unreal.Int32;
  @:ufunction @:thisConst @:final public function IsHDREnabled() : Bool;
