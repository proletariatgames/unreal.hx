...
@:uextern @:uclass extern class UAISense_Hearing extends unreal.aimodule.UAISense {
  ...
  **/
  @:ufunction static public function ReportNoiseEvent(@:bpopt("WorldContext") WorldContext : unreal.UObject, NoiseLocation : unreal.FVector, Loudness : unreal.Float32 = 1.000000, Instigator : unreal.AActor, MaxRange : unreal.Float32 = 0.000000, @:opt("None") Tag : unreal.FName) : Void;
