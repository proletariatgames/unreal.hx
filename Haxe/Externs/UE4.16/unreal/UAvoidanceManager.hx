...
@:uextern @:uclass extern class UAvoidanceManager extends unreal.UObject {
  ...
  **/
  @:ufunction @:final public function GetAvoidanceVelocityIgnoringUID(AvoidanceData : unreal.Const<unreal.PRef<unreal.FNavAvoidanceData>>, DeltaTime : unreal.Float32, IgnoreThisUID : unreal.Int32) : unreal.FVector;
  
  /**
    Only use if you want manual velocity planning. Will not ignore your own volume if you are registered.
  **/
  @:ufunction @:final public function GetAvoidanceVelocity(AvoidanceData : unreal.Const<unreal.PRef<unreal.FNavAvoidanceData>>, DeltaTime : unreal.Float32) : unreal.FVector;
