...
@:uextern @:uclass extern class UNavigationSystem extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction static public function K2_ProjectPointToNavigation(@:bpopt("WorldContext") WorldContext : unreal.UObject, Point : unreal.Const<unreal.PRef<unreal.FVector>>, ProjectedLocation : unreal.PRef<unreal.FVector>, NavData : unreal.ANavigationData, FilterClass : unreal.TSubclassOf<unreal.UNavigationQueryFilter>, QueryExtent : unreal.Const<unreal.FVector>) : Bool;
  ...
  **/
  @:ufunction static public function K2_GetRandomReachablePointInRadius(@:bpopt("WorldContext") WorldContext : unreal.UObject, Origin : unreal.Const<unreal.PRef<unreal.FVector>>, RandomLocation : unreal.PRef<unreal.FVector>, Radius : unreal.Float32, NavData : unreal.ANavigationData, FilterClass : unreal.TSubclassOf<unreal.UNavigationQueryFilter>) : Bool;
  
  /**
    Generates a random location in navigable space within given radius of Origin.
        @return Return Value represents if the call was successful
  **/
  @:ufunction static public function K2_GetRandomPointInNavigableRadius(@:bpopt("WorldContext") WorldContext : unreal.UObject, Origin : unreal.Const<unreal.PRef<unreal.FVector>>, RandomLocation : unreal.PRef<unreal.FVector>, Radius : unreal.Float32, NavData : unreal.ANavigationData, FilterClass : unreal.TSubclassOf<unreal.UNavigationQueryFilter>) : Bool;
