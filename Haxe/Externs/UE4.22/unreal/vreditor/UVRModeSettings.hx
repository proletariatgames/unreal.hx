...
@:uextern @:uclass extern class UVRModeSettings extends unreal.viewportinteraction.UVISettings {
  
  /**
    The class we'll create our interactors from
  **/
  @:uproperty public var TeleporterClass : unreal.TSubclassOf<unreal.vreditor.AVREditorTeleporter>;
  
  /**
    The class we'll create our interactors from
  **/
  @:uproperty public var InteractorClass : unreal.TSubclassOf<unreal.vreditor.UVREditorInteractor>;
  ...
  **/
  @:uproperty public var bAutokeySequences : Bool;
