...
@:uextern @:uclass extern class UKismetProceduralMeshLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function CreateGridMeshWelded(NumX : unreal.Int32, NumY : unreal.Int32, Triangles : unreal.PRef<unreal.TArray<unreal.Int32>>, Vertices : unreal.PRef<unreal.TArray<unreal.FVector>>, UVs : unreal.PRef<unreal.TArray<unreal.FVector2D>>, GridSpacing : unreal.Float32 = 16.000000) : Void;
  ...
  /**
    ...
    @param  GridSpacing             Size of each quad in world units
  **/
  @:ufunction(BlueprintCallable) static public function CreateGridMeshSplit(NumX : unreal.Int32, NumY : unreal.Int32, Triangles : unreal.PRef<unreal.TArray<unreal.Int32>>, Vertices : unreal.PRef<unreal.TArray<unreal.FVector>>, UVs : unreal.PRef<unreal.TArray<unreal.FVector2D>>, UV1s : unreal.PRef<unreal.TArray<unreal.FVector2D>>, GridSpacing : unreal.Float32 = 16.000000) : Void;
