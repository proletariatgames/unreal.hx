...
@:uextern @:uclass extern class UActorRecorderPropertyMap extends unreal.UObject {
  @:uproperty public var Children : unreal.TArray<unreal.takescore.UActorRecorderPropertyMap>;
  
  /**
    Represents properties exposed to Cinematics that can possibly be recorded.
  **/
  @:uproperty public var Properties : unreal.TArray<unreal.takescore.FActorRecordedProperty>;
