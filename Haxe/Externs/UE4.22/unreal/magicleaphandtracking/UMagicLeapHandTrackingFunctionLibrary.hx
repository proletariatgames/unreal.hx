...
@:uextern @:uclass extern class UMagicLeapHandTrackingFunctionLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetConfiguration(ActiveStaticGestures : unreal.PRef<unreal.TArray<unreal.magicleaphandtracking.EHandTrackingGesture>>, KeypointsFilterLevel : unreal.Ref<unreal.magicleaphandtracking.EHandTrackingKeypointFilterLevel>, GestureFilterLevel : unreal.Ref<unreal.magicleaphandtracking.EHandTrackingGestureFilterLevel>, HandSwitchingFilterLevel : unreal.Ref<unreal.magicleaphandtracking.EHandTrackingGestureFilterLevel>, bTrackingEnabled : Bool) : Bool;
  ...
  **/
  ...
  /**
    ...
    @return true if the output param was populated with a valid value, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function GetCurrentGesture(Hand : unreal.inputcore.EControllerHand, Gesture : unreal.Ref<unreal.magicleaphandtracking.EHandTrackingGesture>) : Bool;
