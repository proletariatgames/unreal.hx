...
@:uextern @:uclass extern class UCrashReportsPrivacySettings extends unreal.UObject implements unreal.IImportantToggleSettingInterface {
  ...
  **/
  @:uproperty public var bSendUnattendedBugReports : Bool;
