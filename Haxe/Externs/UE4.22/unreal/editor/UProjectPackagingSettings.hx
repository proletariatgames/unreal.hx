...
@:uextern @:uclass extern class UProjectPackagingSettings extends unreal.UObject {
  ...
  **/
  @:deprecated @:uproperty public var EarlyDownloaderPakFileFiles_DEPRECATED : unreal.TArray<unreal.FString>;
  ...
  **/
  @:uproperty public var CompressedChunkWildcard : unreal.TArray<unreal.FString>;
  ...
  **/
  @:uproperty public var NonUFSMovies : unreal.TArray<unreal.FString>;
  ...
  /**
    ...
    This should be the name with no extension
  **/
  @:uproperty public var UFSMovies : unreal.TArray<unreal.FString>;
  ...
  **/
  @:deprecated @:uproperty public var GenerateEarlyDownloaderPakFile_DEPRECATED : Bool;
  ...
  **/
  @:uproperty public var PakFileAdditionalCompressionOptions : unreal.FString;
  ...
  **/
  @:uproperty public var PakFileCompressionFormats : unreal.FString;
  ...
  **/
  @:uproperty public var MaxChunkSize : unreal.Int64;
  ...
  **/
  @:uproperty public var bForceOneChunkPerFile : Bool;
