...
@:uextern @:uclass extern class UCharacterMovementComponent extends unreal.UPawnMovementComponent implements unreal.IRVOAvoidanceInterface implements unreal.INetworkPredictionInterface {
  ...
  **/
  @:uproperty public var bNetworkAlwaysReplicateTransformUpdateTimestamp : Bool;
  ...
  **/
  @:uproperty public var bEnableServerDualMoveScopedMovementUpdates : Bool;
  ...
  **/
  @:uproperty public var BrakingSubStepTime : unreal.Float32;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLastUpdateLocation() : unreal.FVector;
  
  /**
    Returns the rotation at the end of the last tick.
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLastUpdateRotation() : unreal.FRotator;
  
  /**
    Returns the velocity at the end of the last tick.
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLastUpdateVelocity() : unreal.FVector;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst public function K2_FindFloor(CapsuleLocation : unreal.FVector, FloorResult : unreal.PRef<unreal.FFindFloorResult>) : Void;
  ...
  /**
    ...
    @param FloorResult                    Result of the floor check
  **/
  @:ufunction(BlueprintCallable) @:thisConst public function K2_ComputeFloorDist(CapsuleLocation : unreal.FVector, LineDistance : unreal.Float32, SweepDistance : unreal.Float32, SweepRadius : unreal.Float32, FloorResult : unreal.PRef<unreal.FFindFloorResult>) : Void;
