...
typedef FOnMockDataMeshTrackerUpdated = unreal.DynamicMulticastDelegate<FOnMockDataMeshTrackerUpdated, unreal.Int32->unreal.Const<unreal.PRef<unreal.TArray<unreal.FVector>>>->unreal.Const<unreal.PRef<unreal.TArray<unreal.Int32>>>->unreal.Const<unreal.PRef<unreal.TArray<unreal.FVector>>>->unreal.Const<unreal.PRef<unreal.TArray<unreal.Float32>>>->Void>;