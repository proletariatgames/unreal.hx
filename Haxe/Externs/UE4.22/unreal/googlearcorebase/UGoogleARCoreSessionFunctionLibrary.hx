...
@:uextern @:uclass extern class UGoogleARCoreSessionFunctionLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function CheckARCoreAvailability(WorldContextObject : unreal.UObject, @:bpopt("LatentInfo") LatentInfo : unreal.FLatentActionInfo, OutAvailability : unreal.Ref<unreal.googlearcorebase.EGoogleARCoreAvailability>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function InstallARCoreService(WorldContextObject : unreal.UObject, @:bpopt("LatentInfo") LatentInfo : unreal.FLatentActionInfo, OutInstallResult : unreal.Ref<unreal.googlearcorebase.EGoogleARCoreInstallRequestResult>) : Void;
