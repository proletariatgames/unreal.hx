...
@:noCopy @:noEquals @:uextern @:ustruct extern class FConcertSequencerStateSyncEvent {
  @:uproperty public var SequencerStates : unreal.TArray<unreal.concertsynccore.FConcertSequencerState>;
