...
@:noClass @:uextern @:uclass extern class UUSDSceneImportOptions extends unreal.usdimporter.UUSDImportOptions {
  ...
  **/
  @:uproperty public var bImportProperties : Bool;
  
  /**
    Defines what should happen with existing actors
  **/
  @:uproperty public var ExistingActorPolicy : unreal.usdimporter.EExistingActorPolicy;
  
  /**
    If checked, all actors generated will have a world space transform and will not have any attachment hierarchy
  **/
  @:uproperty public var bFlattenHierarchy : Bool;
