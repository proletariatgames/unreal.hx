...
@:uextern @:uclass extern class ULightComponentBase extends unreal.USceneComponent {
  ...
  **/
  @:uproperty public var SamplesPerPixel : unreal.Int32;
  ...
  **/
  @:uproperty public var bAffectReflection : Bool;
  
  /**
    Whether the light shadows are computed with shadow-mapping or ray-tracing (when available).
  **/
  @:uproperty public var bCastRaytracedShadow : Bool;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetAffectReflection(bNewValue : Bool) : Void;
  @:ufunction(BlueprintCallable) @:final public function SetCastRaytracedShadow(bNewValue : Bool) : Void;
  @:ufunction(BlueprintCallable) @:final public function SetSamplesPerPixel(NewValue : unreal.Int32) : Void;
