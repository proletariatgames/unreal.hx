...
@:uextern @:uclass extern class USkeletalMeshComponent extends unreal.USkinnedMeshComponent implements unreal.IInterface_CollisionDataProvider {
  ...
  **/
  @:uproperty public var bSkipBoundsUpdateWhenInterpolating : Bool;
  ...
  **/
  @:uproperty public var bSkipKinematicUpdateWhenInterpolating : Bool;
  ...
  **/
  @:uproperty public var bPropagateCurvesToSlaves : Bool;
  ...
  **/
  @:uproperty public var bDeferKinematicBoneUpdate : Bool;
