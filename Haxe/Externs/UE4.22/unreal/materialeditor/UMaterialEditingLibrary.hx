...
@:uextern @:uclass extern class UMaterialEditingLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function LayoutMaterialExpressions(Material : unreal.UMaterial) : Void;
  ...
  **/
  ...
  /**
    Layouts the expressions in a grid pattern
  **/
  @:ufunction(BlueprintCallable) static public function LayoutMaterialFunctionExpressions(MaterialFunction : unreal.UMaterialFunction) : Void;
