...
@:uextern @:uclass extern class UAnimationBlueprintLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetAdditiveAnimationType(AnimationSequence : unreal.Const<unreal.UAnimSequence>, AdditiveAnimationType : unreal.Ref<unreal.EAdditiveAnimationType>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetAdditiveBasePoseType(AnimationSequence : unreal.Const<unreal.UAnimSequence>, AdditiveBasePoseType : unreal.Ref<unreal.EAdditiveBasePoseType>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetAnimationInterpolationType(AnimationSequence : unreal.Const<unreal.UAnimSequence>, InterpolationType : unreal.Ref<unreal.EAnimInterpolationType>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetRootMotionLockType(AnimationSequence : unreal.Const<unreal.UAnimSequence>, LockType : unreal.Ref<unreal.ERootMotionRootLock>) : Void;
