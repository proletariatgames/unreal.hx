...
typedef FOnMeshTrackerUpdated = unreal.DynamicMulticastDelegate<FOnMeshTrackerUpdated, unreal.FGuid->unreal.Const<unreal.PRef<unreal.TArray<unreal.FVector>>>->unreal.Const<unreal.PRef<unreal.TArray<unreal.Int32>>>->unreal.Const<unreal.PRef<unreal.TArray<unreal.FVector>>>->unreal.Const<unreal.PRef<unreal.TArray<unreal.Float32>>>->Void>;