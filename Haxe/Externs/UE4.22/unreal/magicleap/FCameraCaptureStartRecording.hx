...
@:uParamName("bSuccess")
@:umodule("MagicLeap")
@:uname("UCameraCaptureComponent.FCameraCaptureStartRecording")
typedef FCameraCaptureStartRecording = unreal.DynamicDelegate<FCameraCaptureStartRecording, Bool->Void>;