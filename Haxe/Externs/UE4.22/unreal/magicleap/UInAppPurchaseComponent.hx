...
@:uextern @:uclass extern class UInAppPurchaseComponent extends unreal.UActorComponent {
  ...
  **/
  ...
  @:uproperty public var GetPurchaseHistoryFailure : unreal.magicleap.FGetPurchaseHistoryFailure;
  @:uproperty public var GetPurchaseHistorySuccess : unreal.magicleap.FGetPurchaseHistorySuccess;
  @:uproperty public var PurchaseConfirmationFailure : unreal.magicleap.FPurchaseConfirmationFailure;
  @:uproperty public var PurchaseConfirmationSuccess : unreal.magicleap.FPurchaseConfirmationSuccess;
  @:uproperty public var GetItemsDetailsFailure : unreal.magicleap.FGetItemsDetailsFailure;
  @:uproperty public var GetItemsDetailsSuccess : unreal.magicleap.FGetItemsDetailsSuccess;
  @:uproperty public var InAppPurchaseLogMessage : unreal.magicleap.FInAppPurchaseLogMessage;
