...
@:uextern @:uclass extern class UStereoLayerFunctionLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetSplashScreen(Texture : unreal.UTexture, @:opt("(X=1.000,Y=1.000)") Scale : unreal.FVector2D, @:opt("0.000000,0.000000,0.000000") Offset : unreal.FVector, bShowLoadingMovie : Bool = false, bShowOnSet : Bool = false) : Void;
