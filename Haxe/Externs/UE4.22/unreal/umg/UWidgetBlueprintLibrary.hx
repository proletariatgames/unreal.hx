...
@:uextern @:uclass extern class UWidgetBlueprintLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function DrawLine(Context : unreal.PRef<unreal.umg.FPaintContext>, PositionA : unreal.FVector2D, PositionB : unreal.FVector2D, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") Tint : unreal.FLinearColor, bAntiAlias : Bool = true, Thickness : unreal.Float32 = 1.000000) : Void;
  ...
  /**
    ...
    @param Thickness             How many pixels thick this line should be.
  **/
  @:ufunction(BlueprintCallable) static public function DrawLines(Context : unreal.PRef<unreal.umg.FPaintContext>, Points : unreal.Const<unreal.PRef<unreal.TArray<unreal.FVector2D>>>, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") Tint : unreal.FLinearColor, bAntiAlias : Bool = true, Thickness : unreal.Float32 = 1.000000) : Void;
  ...
  **/
  ...
  /**
    ...
    @param TopLevelOnly Only the widgets that are direct children of the viewport will be returned.
  **/
  @:ufunction(BlueprintCallable) static public function GetAllWidgetsWithInterface(WorldContextObject : unreal.UObject, FoundWidgets : unreal.PRef<unreal.TArray<unreal.umg.UUserWidget>>, Interface : unreal.TSubclassOf<unreal.IInterface>, TopLevelOnly : Bool) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetColorVisionDeficiencyType(Type : unreal.slatecore.EColorVisionDeficiency, Severity : unreal.Float32, CorrectDeficiency : Bool, ShowCorrectionWithDeficiency : Bool) : Void;
