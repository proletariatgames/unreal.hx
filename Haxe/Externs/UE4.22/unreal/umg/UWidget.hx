...
@:uextern @:uclass extern class UWidget extends unreal.umg.UVisual {
  ...
  **/
  @:uproperty public var FlowDirectionPreference : unreal.slatecore.EFlowDirectionPreference;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst public function IsHovered() : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function HasMouseCaptureByUser(UserIndex : unreal.Int32, PointerIndex : unreal.Int32 = -1) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetGameInstance() : unreal.UGameInstance;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst public function GetOwningLocalPlayer() : unreal.ULocalPlayer;
