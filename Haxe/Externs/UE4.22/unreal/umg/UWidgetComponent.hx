...
@:uextern @:uclass extern class UWidgetComponent extends unreal.UMeshComponent {
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetDrawAtDesiredSize(InbDrawAtDesiredSize : Bool) : Void;
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetRedrawTime() : unreal.Float32;
  @:ufunction(BlueprintCallable) @:final public function SetRedrawTime(bInRedrawTime : unreal.Float32) : Void;
