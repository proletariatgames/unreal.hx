...
@:uextern @:uclass extern class UPanelWidget extends unreal.umg.UWidget {
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetAllChildren() : unreal.TArray<unreal.umg.UWidget>;
  
  /**
    Gets the index of a specific child widget
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetChildIndex(Content : unreal.Const<unreal.umg.UWidget>) : unreal.Int32;
  ...
  **/
  @:ufunction(BlueprintCallable) public function ClearChildren() : Void;
