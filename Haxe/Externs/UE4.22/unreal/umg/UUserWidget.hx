...
@:uextern @:uclass extern class UUserWidget extends unreal.umg.UWidget implements unreal.umg.INamedSlotInterface {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function PlayAnimation(InAnimation : unreal.umg.UWidgetAnimation, StartAtTime : unreal.Float32 = 0.000000, NumLoopsToPlay : unreal.Int32 = 1, PlayMode : unreal.umg.EUMGSequencePlayMode = Forward, PlaybackSpeed : unreal.Float32 = 1.000000) : unreal.umg.UUMGSequencePlayer;
  ...
  **/
  ...
  /**
    ...
    @param PlaybackSpeed The speed at which the animation should play
  **/
  @:ufunction(BlueprintCallable) @:final public function PlayAnimationForward(InAnimation : unreal.umg.UWidgetAnimation, PlaybackSpeed : unreal.Float32 = 1.000000) : unreal.umg.UUMGSequencePlayer;
  ...
  /**
    ...
    @param PlaybackSpeed The speed at which the animation should play
  **/
  @:ufunction(BlueprintCallable) @:final public function PlayAnimationReverse(InAnimation : unreal.umg.UWidgetAnimation, PlaybackSpeed : unreal.Float32 = 1.000000) : unreal.umg.UUMGSequencePlayer;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final private function StopListeningForAllInputActionsAndAxes() : Void;
  #else
  /**
    Stops listening to all input actions, and unregisters the input component with the player controller.
  **/
