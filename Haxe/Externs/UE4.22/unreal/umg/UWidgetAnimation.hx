...
@:uextern @:uclass extern class UWidgetAnimation extends unreal.moviescene.UMovieSceneSequence {
  ...
  **/
  @:deprecated @:uproperty public var OnAnimationFinished_DEPRECATED : unreal.umg.FOnWidgetAnimationPlaybackStatusChanged;
  
  /**
    Fires when the widget animation starts playing.
  **/
  @:deprecated @:uproperty public var OnAnimationStarted_DEPRECATED : unreal.umg.FOnWidgetAnimationPlaybackStatusChanged;
