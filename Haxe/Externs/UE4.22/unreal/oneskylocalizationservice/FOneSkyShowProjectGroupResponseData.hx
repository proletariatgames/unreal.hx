...
@:noCopy @:noEquals @:uextern @:ustruct extern class FOneSkyShowProjectGroupResponseData {
  @:uproperty public var project_count : unreal.FString;
  @:uproperty public var description : unreal.Int32;
