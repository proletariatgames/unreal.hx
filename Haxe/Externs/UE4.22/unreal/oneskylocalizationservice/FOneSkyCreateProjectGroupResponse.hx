...
@:noCopy @:noEquals @:uextern @:ustruct extern class FOneSkyCreateProjectGroupResponse {
  @:uproperty public var data : unreal.oneskylocalizationservice.FOneSkyCreateProjectGroupResponseData;
  @:uproperty public var meta : unreal.oneskylocalizationservice.FOneSkyCreateProjectGroupResponseMeta;
