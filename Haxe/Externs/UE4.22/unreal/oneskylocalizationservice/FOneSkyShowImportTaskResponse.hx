...
@:noCopy @:noEquals @:uextern @:ustruct extern class FOneSkyShowImportTaskResponse {
  @:uproperty public var data : unreal.oneskylocalizationservice.FOneSkyShowImportTaskResponseData;
  @:uproperty public var meta : unreal.oneskylocalizationservice.FOneSkyShowImportTaskResponseMeta;
