...
@:noCopy @:noEquals @:uextern @:ustruct extern class FOneSkyUploadFileResponse {
  @:uproperty public var data : unreal.oneskylocalizationservice.FOneSkyUploadFileResponseData;
  @:uproperty public var meta : unreal.oneskylocalizationservice.FOneSkyUploadFileResponseMeta;
