...
@:noCopy @:noEquals @:uextern @:ustruct extern class FOneSkyShowProjectResponse {
  @:uproperty public var data : unreal.oneskylocalizationservice.FOneSkyShowProjectResponseData;
  @:uproperty public var meta : unreal.oneskylocalizationservice.FOneSkyShowProjectResponseMeta;
