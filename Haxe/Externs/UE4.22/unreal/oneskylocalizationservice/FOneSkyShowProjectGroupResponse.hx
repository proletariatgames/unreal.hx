...
@:noCopy @:noEquals @:uextern @:ustruct extern class FOneSkyShowProjectGroupResponse {
  @:uproperty public var data : unreal.oneskylocalizationservice.FOneSkyShowProjectGroupResponseData;
  @:uproperty public var meta : unreal.oneskylocalizationservice.FOneSkyShowProjectGroupResponseMeta;
