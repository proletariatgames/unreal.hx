...
@:noClass @:uextern @:uclass extern class UTakeRecorderWorldSourceSettings extends unreal.takescore.UTakeRecorderSource {
  
  /**
    Add a binding and track for all actors that aren't explicitly being recorded
  **/
  @:uproperty public var bAutotrackActors : Bool;
  
  /**
    Record world settings
  **/
  @:uproperty public var bRecordWorldSettings : Bool;
