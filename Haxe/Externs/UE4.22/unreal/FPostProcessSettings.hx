...
@:noCopy @:noEquals @:uextern @:ustruct extern class FPostProcessSettings {
  ...
  **/
  @:uproperty public var PathTracingSamplesPerPixel : unreal.Int32;
  
  /**
    Sets the path tracing maximum bounces
  **/
  @:uproperty public var PathTracingMaxBounces : unreal.Int32;
  ...
  **/
  @:uproperty public var RayTracingTranslucencyRefraction : Bool;
  
  /**
    Sets the translucency shadows type.
  **/
  @:uproperty public var RayTracingTranslucencyShadows : unreal.EReflectedAndRefractedRayTracedShadows;
  
  /**
    Sets the samples per pixel for ray traced translucency.
  **/
  @:uproperty public var RayTracingTranslucencySamplesPerPixel : unreal.Int32;
  
  /**
    Sets the maximum number of ray tracing refraction rays.
  **/
  @:uproperty public var RayTracingTranslucencyRefractionRays : unreal.Int32;
  ...
  **/
  @:uproperty public var RayTracingTranslucencyMaxRoughness : unreal.Float32;
  
  /**
    Sets the translucency type
  **/
  @:uproperty public var TranslucencyType : unreal.ETranslucencyType;
  
  /**
    Sets the reflected shadows type.
  **/
  @:uproperty public var RayTracingReflectionsShadows : unreal.EReflectedAndRefractedRayTracedShadows;
  
  /**
    Sets the samples per pixel for ray traced reflections.
  **/
  @:uproperty public var RayTracingReflectionsSamplesPerPixel : unreal.Int32;
  
  /**
    Sets the maximum number of ray tracing reflection bounces.
  **/
  @:uproperty public var RayTracingReflectionsMaxBounces : unreal.Int32;
  ...
  **/
  @:uproperty public var RayTracingReflectionsMaxRoughness : unreal.Float32;
  ...
  **/
  @:uproperty public var ReflectionsType : unreal.EReflectionsType;
  ...
  **/
  @:uproperty public var RayTracingGISamplesPerPixel : unreal.Int32;
  
  /**
    Sets the ray tracing global illumination maximum bounces.
  **/
  @:uproperty public var RayTracingGIMaxBounces : unreal.Int32;
  
  /**
    Enables ray tracing global illumination.
  **/
  @:uproperty public var RayTracingGI : Bool;
  ...
  **/
  ...
  /**
    Sets the samples per pixel for ray tracing global illumination.
  **/
  @:uproperty public var RayTracingAOSamplesPerPixel : unreal.Int32;
  ...
  **/
  @:uproperty public var AutoExposureBiasCurve : unreal.UCurveFloat;
  ...
  **/
  ...
  @:uproperty public var bOverride_PathTracingSamplesPerPixel : Bool;
  @:uproperty public var bOverride_PathTracingMaxBounces : Bool;
  @:uproperty public var bOverride_RayTracingGISamplesPerPixel : Bool;
  @:uproperty public var bOverride_RayTracingGIMaxBounces : Bool;
  @:uproperty public var bOverride_RayTracingGI : Bool;
  @:uproperty public var bOverride_RayTracingTranslucencyRefraction : Bool;
  @:uproperty public var bOverride_RayTracingTranslucencyShadows : Bool;
  @:uproperty public var bOverride_RayTracingTranslucencySamplesPerPixel : Bool;
  @:uproperty public var bOverride_RayTracingTranslucencyRefractionRays : Bool;
  @:uproperty public var bOverride_RayTracingTranslucencyMaxRoughness : Bool;
  @:uproperty public var bOverride_TranslucencyType : Bool;
  @:uproperty public var bOverride_RayTracingReflectionsShadows : Bool;
  @:uproperty public var bOverride_RayTracingReflectionsSamplesPerPixel : Bool;
  @:uproperty public var bOverride_RayTracingReflectionsMaxBounces : Bool;
  @:uproperty public var bOverride_RayTracingReflectionsMaxRoughness : Bool;
  
  /**
    Ray Tracing
  **/
  @:uproperty public var bOverride_ReflectionsType : Bool;
  ...
  @:uproperty public var bOverride_RayTracingAOSamplesPerPixel : Bool;
  ...
  @:uproperty public var bOverride_AutoExposureBiasCurve : Bool;
