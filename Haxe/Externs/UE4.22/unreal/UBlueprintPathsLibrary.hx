...
@:uextern @:uclass extern class UBlueprintPathsLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function CreateTempFilename(Path : unreal.FString, Prefix : unreal.FString, Extension : unreal.FString = ".tmp") : unreal.FString;
