...
@:uextern @:uclass extern class UPathFollowingComponent extends unreal.UActorComponent implements unreal.aimodule.IAIResourceInterface implements unreal.IPathFollowingAgentInterface {
  ...
  **/
  ...
  /**
    called when NavigationSystem registers new navigation data type while this component
        ...
        on levels.
  **/
  @:ufunction @:final private function OnNavDataRegistered(NavData : unreal.navigationsystem.ANavigationData) : Void;
  // AIResourceInterface interface implementation
  // PathFollowingAgentInterface interface implementation
