...
@:uextern @:uclass extern class UEnvQueryInstanceBlueprintWrapper extends unreal.UObject implements unreal.aimodule.IEQSQueryResultSourceInterface {
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetItemScore(ItemIndex : unreal.Int32) : unreal.Float32;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetQueryResultsAsActors(ResultActors : unreal.PRef<unreal.TArray<unreal.AActor>>) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetQueryResultsAsLocations(ResultLocations : unreal.PRef<unreal.TArray<unreal.FVector>>) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetResultsAsActors() : unreal.TArray<unreal.AActor>;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetResultsAsLocations() : unreal.TArray<unreal.FVector>;
