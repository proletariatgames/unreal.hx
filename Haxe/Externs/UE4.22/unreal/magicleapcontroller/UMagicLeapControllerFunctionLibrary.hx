...
@:uextern @:uclass extern class UMagicLeapControllerFunctionLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetControllerMapping(ControllerIndex : unreal.Int32, Hand : unreal.Ref<unreal.inputcore.EControllerHand>) : Bool;
