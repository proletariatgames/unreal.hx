...
@:uextern @:uclass extern class UKismetInternationalizationLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  /**
    ...
    @return The culture as an IETF language tag (eg, "zh-Hans-CN").
  **/
  @:ufunction(BlueprintCallable) static public function GetSuitableCulture(AvailableCultures : unreal.Const<unreal.PRef<unreal.TArray<unreal.FString>>>, CultureToMatch : unreal.FString, FallbackCulture : unreal.FString = "en") : unreal.FString;
