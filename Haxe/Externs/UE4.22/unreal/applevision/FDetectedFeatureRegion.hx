...
@:uextern @:ustruct extern class FDetectedFeatureRegion extends unreal.applevision.FDetectedFeature {
  
  /**
    The set of points that encompass the detected feature area
  **/
  @:uproperty public var Points : unreal.TArray<unreal.FVector2D>;
