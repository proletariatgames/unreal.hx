...
@:uextern @:uclass extern class ULiveLinkRemapAsset extends unreal.livelink.ULiveLinkRetargetAsset {
  
  /**
    Blueprint Implementable function for getting a remapped bone name from the original
  **/
  @:ufunction(BlueprintNativeEvent) @:thisConst public function GetRemappedBoneName(BoneName : unreal.FName) : unreal.FName;
  
  /**
    Blueprint Implementable function for getting a remapped curve name from the original
  **/
  @:ufunction(BlueprintNativeEvent) @:thisConst public function GetRemappedCurveName(CurveName : unreal.FName) : unreal.FName;
