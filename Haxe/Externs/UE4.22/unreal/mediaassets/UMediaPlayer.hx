...
@:uextern @:uclass extern class UMediaPlayer extends unreal.UObject {
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLastAudioSampleProcessedTime() : unreal.FTimespan;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLastVideoSampleProcessedTime() : unreal.FTimespan;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function IsClosed() : Bool;
  ...
  **/
  ...
  /**
    ...
    @see Close, OpenFile, OpenPlaylist, OpenPlaylistIndex, OpenUrl, Reopen
  **/
  @:ufunction(BlueprintCallable) @:final public function OpenSourceLatent(WorldContextObject : unreal.Const<unreal.UObject>, @:bpopt("LatentInfo") LatentInfo : unreal.FLatentActionInfo, MediaSource : unreal.mediaassets.UMediaSource, Options : unreal.Const<unreal.PRef<unreal.mediautils.FMediaPlayerOptions>>, bSuccess : Bool) : Void;
