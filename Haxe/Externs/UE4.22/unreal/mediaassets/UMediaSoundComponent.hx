...
@:uextern @:uclass extern class UMediaSoundComponent extends unreal.audiomixer.USynthComponent {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetEnableSpectralAnalysis(bInSpectralAnalysisEnabled : Bool) : Void;
  
  /**
    Sets the settings to use for spectral analysis.
  **/
  @:ufunction(BlueprintCallable) @:final public function SetSpectralAnalysisSettings(InFrequenciesToAnalyze : unreal.TArray<unreal.Float32>, @:opt("Medium_512") InFFTSize : unreal.mediaassets.EMediaSoundComponentFFTSize) : Void;
  
  /**
    Retrieves the spectral data if spectral analysis is enabled.
  **/
  @:ufunction(BlueprintCallable) @:final public function GetSpectralData() : unreal.TArray<unreal.mediaassets.FMediaSoundComponentSpectralData>;
  
  /**
    Turns on amplitude envelope following the audio in the media sound component.
  **/
  @:ufunction(BlueprintCallable) @:final public function SetEnableEnvelopeFollowing(bInEnvelopeFollowing : Bool) : Void;
  
  /**
    Sets the envelope attack and release times (in ms).
  **/
  @:ufunction(BlueprintCallable) @:final public function SetEnvelopeFollowingsettings(AttackTimeMsec : unreal.Int32, ReleaseTimeMsec : unreal.Int32) : Void;
  
  /**
    Retrieves the current amplitude envelope.
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetEnvelopeValue() : unreal.Float32;
