...
@:uextern @:ustruct extern class FFoundMIDIDevice {
  
  /**
    True if this is the default MIDI device for output on this system
  **/
  @:uproperty public var bIsDefaultOutputDevice : Bool;
  
  /**
    True if this is the default MIDI device for input on this system
  **/
  @:uproperty public var bIsDefaultInputDevice : Bool;
  ...
  **/
  @:uproperty public var bCanSendTo : Bool;
  
  /**
    True if the device supports sending events to us
  **/
  @:uproperty public var bCanReceiveFrom : Bool;
