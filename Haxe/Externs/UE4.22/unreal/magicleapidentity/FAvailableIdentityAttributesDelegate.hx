...
typedef FAvailableIdentityAttributesDelegate = unreal.DynamicDelegate<FAvailableIdentityAttributesDelegate, unreal.magicleapidentity.EMagicLeapIdentityError->unreal.Const<unreal.PRef<unreal.TArray<unreal.magicleapidentity.EMagicLeapIdentityKey>>>->Void>;