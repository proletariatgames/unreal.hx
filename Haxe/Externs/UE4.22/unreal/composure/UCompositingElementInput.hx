...
@:uextern @:uclass extern class UCompositingElementInput extends unreal.composure.UCompositingElementPass {
  ...
  **/
  ...
  @:ufunction(BlueprintNativeEvent) private function GenerateInput() : unreal.UTexture;
