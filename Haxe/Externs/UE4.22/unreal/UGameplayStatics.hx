...
@:uextern @:uclass extern class UGameplayStatics extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  /**
    ...
    @return An audio component to manipulate the spawned sound
  **/
  @:ufunction(BlueprintCallable) static public function SpawnSoundAtLocation(WorldContextObject : unreal.Const<unreal.UObject>, Sound : unreal.USoundBase, Location : unreal.FVector, Rotation : unreal.FRotator, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") AttenuationSettings : unreal.USoundAttenuation, @:opt("None") ConcurrencySettings : unreal.USoundConcurrency, bAutoDestroy : Bool = true, @:opt("None") Owner : unreal.AActor) : unreal.UAudioComponent;
