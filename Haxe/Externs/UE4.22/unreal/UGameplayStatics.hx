...
@:uextern @:uclass extern class UGameplayStatics extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) static public function BeginSpawningActorFromClass(WorldContextObject : unreal.Const<unreal.UObject>, ActorClass : unreal.TSubclassOf<unreal.AActor>, SpawnTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, bNoCollisionFail : Bool = false, @:opt("None") Owner : unreal.AActor) : unreal.AActor;

  /**
    Spawns an instance of an actor class, but does not automatically run its construction script.
  **/
  @:ufunction(BlueprintCallable) static public function BeginDeferredActorSpawnFromClass(WorldContextObject : unreal.Const<unreal.UObject>, ActorClass : unreal.TSubclassOf<unreal.AActor>, SpawnTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, @:opt("Undefined") CollisionHandlingOverride : unreal.ESpawnActorCollisionHandlingMethod, @:opt("None") Owner : unreal.AActor) : unreal.AActor;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function CreatePlayer(WorldContextObject : unreal.Const<unreal.UObject>, ControllerId : unreal.Int32 = -1, bSpawnPlayerController : Bool = true) : unreal.APlayerController;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function UnloadStreamLevel(WorldContextObject : unreal.Const<unreal.UObject>, LevelName : unreal.FName, @:bpopt("LatentInfo") LatentInfo : unreal.FLatentActionInfo, bShouldBlockOnUnload : Bool) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetEnableWorldRendering(WorldContextObject : unreal.Const<unreal.UObject>, bEnable : Bool) : Void;

  /**
    Returns the world rendering state
    @return      Whether the world should be rendered or not
  **/
  @:ufunction(BlueprintCallable) static public function GetEnableWorldRendering(WorldContextObject : unreal.Const<unreal.UObject>) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SpawnEmitterAtLocation(WorldContextObject : unreal.Const<unreal.UObject>, EmitterTemplate : unreal.UParticleSystem, Location : unreal.FVector, Rotation : unreal.FRotator, @:opt("1.000000,1.000000,1.000000") Scale : unreal.FVector, bAutoDestroy : Bool = true, @:opt("None") PoolingMethod : unreal.EPSCPoolMethod) : unreal.UParticleSystemComponent;
  ...
  /**
    ...
    @param PoolingMethod - Method used for pooling this component. Defaults to none.
  **/
  @:ufunction(BlueprintCallable) static public function SpawnEmitterAttached(EmitterTemplate : unreal.UParticleSystem, AttachToComponent : unreal.USceneComponent, @:opt("None") AttachPointName : unreal.FName, Location : unreal.FVector, Rotation : unreal.FRotator, @:opt("1.000000,1.000000,1.000000") Scale : unreal.FVector, LocationType : unreal.EAttachLocation = KeepRelativeOffset, bAutoDestroy : Bool = true, @:opt("None") PoolingMethod : unreal.EPSCPoolMethod) : unreal.UParticleSystemComponent;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function PlaySound2D(WorldContextObject : unreal.Const<unreal.UObject>, Sound : unreal.USoundBase, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") ConcurrencySettings : unreal.USoundConcurrency, @:opt("None") OwningActor : unreal.AActor) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SpawnSound2D(WorldContextObject : unreal.Const<unreal.UObject>, Sound : unreal.USoundBase, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") ConcurrencySettings : unreal.USoundConcurrency, bPersistAcrossLevelTransition : Bool = false, bAutoDestroy : Bool = true) : unreal.UAudioComponent;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function CreateSound2D(WorldContextObject : unreal.Const<unreal.UObject>, Sound : unreal.USoundBase, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") ConcurrencySettings : unreal.USoundConcurrency, bPersistAcrossLevelTransition : Bool = false, bAutoDestroy : Bool = true) : unreal.UAudioComponent;
  ...
  /**
    ...
    @param OwningActor - The actor to use as the "owner" for concurrency settings purposes. Allows PlaySound calls to do a concurrency limit per owner.
            // THIS WILL CAUSE A CONFLICT IN 4.18, ACCEPT SOURCE - copied change 3605787: "Adding ability to pass in an optional owner in PlaySound2D and PlaySoundAtLocation BP calls"
  **/
  @:ufunction(BlueprintCallable) static public function PlaySoundAtLocation(WorldContextObject : unreal.Const<unreal.UObject>, Sound : unreal.USoundBase, Location : unreal.FVector, Rotation : unreal.FRotator, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") AttenuationSettings : unreal.USoundAttenuation, @:opt("None") ConcurrencySettings : unreal.USoundConcurrency, @:opt("None") OwningActor : unreal.AActor) : Void;
  ...
  **/
  #if proletariat
  @:ufunction(BlueprintCallable) static public function SpawnSoundAtLocation(WorldContextObject : unreal.Const<unreal.UObject>, Sound : unreal.USoundBase, Location : unreal.FVector, @:opt(FRotator.ZeroRotator) ?Rotation : unreal.FRotator, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") AttenuationSettings : unreal.USoundAttenuation, @:opt("None") ConcurrencySettings : unreal.USoundConcurrency, bAutoDestroy : Bool = true, @:opt("None") Owner : unreal.AActor) : unreal.UAudioComponent;
  #else
  @:ufunction(BlueprintCallable) static public function SpawnSoundAtLocation(WorldContextObject : unreal.Const<unreal.UObject>, Sound : unreal.USoundBase, Location : unreal.FVector, @:opt(FRotator.ZeroRotator) ?Rotation : unreal.FRotator, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") AttenuationSettings : unreal.USoundAttenuation, @:opt("None") ConcurrencySettings : unreal.USoundConcurrency, bAutoDestroy : Bool = true) : unreal.UAudioComponent;
  #end
  ...
  **/
  #if proletariat
  @:ufunction(BlueprintCallable) static public function SpawnSoundAttached(Sound : unreal.USoundBase, AttachToComponent : unreal.USceneComponent, @:opt("None") AttachPointName : unreal.FName, Location : unreal.FVector, Rotation : unreal.FRotator, LocationType : unreal.EAttachLocation = KeepRelativeOffset, bStopWhenAttachedToDestroyed : Bool = false, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") AttenuationSettings : unreal.USoundAttenuation, @:opt("None") ConcurrencySettings : unreal.USoundConcurrency, bAutoDestroy : Bool = true, @:opt("None") Owner : unreal.AActor) : unreal.UAudioComponent;
  #else
  @:ufunction(BlueprintCallable) static public function SpawnSoundAttached(Sound : unreal.USoundBase, AttachToComponent : unreal.USceneComponent, @:opt("None") AttachPointName : unreal.FName, Location : unreal.FVector, Rotation : unreal.FRotator, LocationType : unreal.EAttachLocation = KeepRelativeOffset, bStopWhenAttachedToDestroyed : Bool = false, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") AttenuationSettings : unreal.USoundAttenuation, @:opt("None") ConcurrencySettings : unreal.USoundConcurrency, bAutoDestroy : Bool = true) : unreal.UAudioComponent;
  #end
  ...
  **/
  ...
  /**
    ...
    @param AttenuationSettings - Override attenuation settings package to play sound with
  **/
  @:ufunction(BlueprintCallable) static public function PlayDialogueAtLocation(WorldContextObject : unreal.Const<unreal.UObject>, Dialogue : unreal.UDialogueWave, Context : unreal.Const<unreal.PRef<unreal.FDialogueContext>>, Location : unreal.FVector, Rotation : unreal.FRotator, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") AttenuationSettings : unreal.USoundAttenuation) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SpawnDialogueAtLocation(WorldContextObject : unreal.Const<unreal.UObject>, Dialogue : unreal.UDialogueWave, Context : unreal.Const<unreal.PRef<unreal.FDialogueContext>>, Location : unreal.FVector, Rotation : unreal.FRotator, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") AttenuationSettings : unreal.USoundAttenuation, bAutoDestroy : Bool = true) : unreal.UAudioComponent;
  ...
  /**
    ...
    @return Audio Component to manipulate the playing dialogue with
  **/
  @:ufunction(BlueprintCallable) static public function SpawnDialogueAttached(Dialogue : unreal.UDialogueWave, Context : unreal.Const<unreal.PRef<unreal.FDialogueContext>>, AttachToComponent : unreal.USceneComponent, @:opt("None") AttachPointName : unreal.FName, Location : unreal.FVector, Rotation : unreal.FRotator, LocationType : unreal.EAttachLocation = KeepRelativeOffset, bStopWhenAttachedToDestroyed : Bool = false, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") AttenuationSettings : unreal.USoundAttenuation, bAutoDestroy : Bool = true) : unreal.UAudioComponent;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetMaxAudioChannelsScaled(WorldContextObject : unreal.Const<unreal.UObject>, MaxChannelCountScale : unreal.Float32) : Void;

  /**
    Retrieves the max voice count currently used by the audio engine.
  **/
  @:ufunction(BlueprintCallable) static public function GetMaxAudioChannelCount(WorldContextObject : unreal.Const<unreal.UObject>) : unreal.Int32;
