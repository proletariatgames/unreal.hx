...
@:noClass @:uextern @:uclass extern class UAssetRegistryImpl extends unreal.UObject implements unreal.assetregistry.IAssetRegistry {
  ...
  **/
  ...
  /**
    Trims items out of the asset data list that do not pass the supplied filter
  **/
  @:ufunction(BlueprintCallable) @:thisConst public function UseFilterToExcludeAssets(AssetDataList : unreal.PRef<unreal.TArray<unreal.assetregistry.FAssetData>>, Filter : unreal.Const<unreal.PRef<unreal.assetregistry.FARFilter>>) : Void;
