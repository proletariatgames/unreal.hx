...
@:uextern @:uclass extern class UExponentialHeightFogComponent extends unreal.USceneComponent {
  ...
  /**
    This is set when the component spawns
  **/
  @:uproperty public var DefaultFogParams : unreal.FExponentialHeightFogInterpParams;
  @:uproperty public var FogVolumePriority : unreal.Float32;
  
  /**
    Distance over which this fog volume should blend in (if it's not the global volume!)
  **/
  @:uproperty public var FogVolumeBlendDistance : unreal.Float32;
  
  /**
    Set this to false to use the parent shape component as volume bounds. True affects the whole world regardless.
  **/
  @:uproperty public var bFogVolumeUnbound : Bool;
  ...
  **/
  @:uproperty public var SecondFogData : unreal.FExponentialHeightFogData;
