...
**/
package unreal.androidcamerafactory;

/**
  Settings for the ImgMedia module.
**/
@:umodule("AndroidCameraFactory")
@:glueCppIncludes("AndroidCameraSettings.h")
@:uextern @:uclass extern class UAndroidCameraSettings extends unreal.UObject {
