...
@:uextern @:uclass extern class UAISense_Blueprint extends unreal.aimodule.UAISense {
  @:uproperty private var UnprocessedEvents : unreal.TArray<unreal.aimodule.UAISenseEvent>;
  @:uproperty private var ListenerContainer : unreal.TArray<unreal.aimodule.UAIPerceptionComponent>;
  @:uproperty private var ListenerDataType : unreal.TSubclassOf<unreal.UUserDefinedStruct>;
