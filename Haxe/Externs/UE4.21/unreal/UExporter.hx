...
@:uextern @:uclass extern class UExporter extends unreal.UObject {
  @:uproperty public var ExportTask : unreal.UAssetExportTask;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function RunAssetExportTask(Task : unreal.UAssetExportTask) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function RunAssetExportTasks(ExportTasks : unreal.Const<unreal.PRef<unreal.TArray<unreal.UAssetExportTask>>>) : Bool;
