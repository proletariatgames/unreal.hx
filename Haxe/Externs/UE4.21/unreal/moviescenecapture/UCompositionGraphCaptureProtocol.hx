...
@:uextern @:uclass extern class UCompositionGraphCaptureProtocol extends unreal.moviescenecapture.UMovieSceneImageCaptureProtocolBase {
  
  /**
    Whether to disable screen percentage
  **/
  @:uproperty public var bDisableScreenPercentage : Bool;
