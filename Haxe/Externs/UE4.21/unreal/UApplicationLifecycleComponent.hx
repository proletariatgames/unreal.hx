...
@:uextern @:uclass extern class UApplicationLifecycleComponent extends unreal.UActorComponent {
  ...
  **/
  @:uproperty public var OnLowPowerModeDelegate : unreal.FOnLowPowerModeDelegate;
  
  /**
    Called when temperature level has changed, and receives the severity
  **/
  @:uproperty public var OnTemperatureChangeDelegate : unreal.FOnTemperatureChangeDelegate;
  ...
  **/
  @:uproperty public var ApplicationReceivedStartupArgumentsDelegate : unreal.FApplicationStartupArgumentsDelegate;
  ...
  **/
  @:uproperty public var ApplicationShouldUnloadResourcesDelegate : unreal.FApplicationLifetimeDelegate;
