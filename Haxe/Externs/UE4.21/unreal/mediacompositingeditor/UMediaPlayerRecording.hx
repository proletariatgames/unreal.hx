...
@:uextern @:uclass extern class UMediaPlayerRecording extends unreal.sequencerecorder.USequenceRecordingBase {
  
  /**
    Whether this MediaPlayer is active and his event will be recorded when the 'Record' button is pressed.
  **/
  @:uproperty public var RecordingSettings : unreal.mediacompositingeditor.FMediaPlayerRecordingSettings;
