...
@:uParamName("FilePath")
@:umodule("MagicLeap")
@:uname("UCameraCaptureComponent.FCameraCaptureImgToFileSuccess")
typedef FCameraCaptureImgToFileSuccess = unreal.DynamicMulticastDelegate<FCameraCaptureImgToFileSuccess, unreal.FString->Void>;