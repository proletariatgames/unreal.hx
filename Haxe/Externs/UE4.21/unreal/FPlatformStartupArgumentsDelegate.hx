...
typedef FPlatformStartupArgumentsDelegate = unreal.DynamicMulticastDelegate<FPlatformStartupArgumentsDelegate, unreal.Const<unreal.PRef<unreal.TArray<unreal.FString>>>->Void>;