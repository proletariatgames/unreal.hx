...
@:uextern @:uclass extern class UMaterialInstanceDynamic extends unreal.UMaterialInstance {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetScalarParameterValue(ParameterName : unreal.FName, Value : unreal.Float32) : Void;
  
  /**
    Get the current scalar (float) parameter value from an MID
  **/
  @:ufunction(BlueprintCallable) @:final public function K2_GetScalarParameterValue(ParameterName : unreal.FName) : unreal.Float32;
  
  /**
    Set an MID texture parameter value
  **/
  @:ufunction(BlueprintCallable) @:final public function SetTextureParameterValue(ParameterName : unreal.FName, Value : unreal.UTexture) : Void;
  
  /**
    Get the current MID texture parameter value
  **/
  @:ufunction(BlueprintCallable) @:final public function K2_GetTextureParameterValue(ParameterName : unreal.FName) : unreal.UTexture;
  
  /**
    Set an MID vector parameter value
  **/
  @:ufunction(BlueprintCallable) @:final public function SetVectorParameterValue(ParameterName : unreal.FName, Value : unreal.FLinearColor) : Void;
  
  /**
    Get the current MID vector parameter value
  **/
  @:ufunction(BlueprintCallable) @:final public function K2_GetVectorParameterValue(ParameterName : unreal.FName) : unreal.FLinearColor;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function K2_InterpolateMaterialInstanceParams(SourceA : unreal.UMaterialInstance, SourceB : unreal.UMaterialInstance, Alpha : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function K2_CopyMaterialInstanceParameters(Source : unreal.UMaterialInterface, bQuickParametersOnly : Bool = false) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function CopyParameterOverrides(MaterialInstance : unreal.UMaterialInstance) : Void;
