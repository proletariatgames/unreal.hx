...
@:uextern @:uclass extern class UVREditorAssetContainer extends unreal.UDataAsset {
  ...
  **/
  ...
  @:uproperty public var TranslucentTextMaterial : unreal.UMaterialInterface;
  @:uproperty public var LineMaterial : unreal.UMaterial;
  ...
  **/
  ...
  @:uproperty public var DockingButtonMesh : unreal.UStaticMesh;
  @:uproperty public var JointSphereMesh : unreal.UStaticMesh;
  @:uproperty public var LineSegmentCylinderMesh : unreal.UStaticMesh;
