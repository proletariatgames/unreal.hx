...
typedef FApplicationStartupArgumentsDelegate = unreal.DynamicMulticastDelegate<FApplicationStartupArgumentsDelegate, unreal.Const<unreal.PRef<unreal.TArray<unreal.FString>>>->Void>;