...
typedef FOnProjectileBounceDelegate = unreal.DynamicMulticastDelegate<FOnProjectileBounceDelegate, unreal.Const<unreal.PRef<unreal.FHitResult>>->unreal.Const<unreal.PRef<unreal.FVector>>->Void>;