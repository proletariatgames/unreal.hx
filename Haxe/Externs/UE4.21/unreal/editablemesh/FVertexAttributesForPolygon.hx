...
@:noCopy @:noEquals @:uextern @:ustruct extern class FVertexAttributesForPolygon {
  ...
  **/
  @:uproperty public var VertexAttributeListsForEachHole : unreal.TArray<unreal.editablemesh.FVertexAttributesForPolygonHole>;
  
  /**
    For each polygon vertex, a list of attributes for that vertex.  Can be left empty if you don't want to set any attributes.
  **/
  @:uproperty public var PerimeterVertexAttributeLists : unreal.TArray<unreal.editablemesh.FMeshElementAttributeList>;
