...
@:noCopy @:noEquals @:uextern @:ustruct extern class FSubdivisionLimitSection {
  
  /**
    All of the quads in this section, as a result from subdividing the mesh
  **/
  @:uproperty public var SubdividedQuads : unreal.TArray<unreal.editablemesh.FSubdividedQuad>;
