...
@:noCopy @:noEquals @:uextern @:ustruct extern class FPolygonHoleVertices {
  
  /**
    Ordered list of vertices that defines the hole's contour, along with the polygon vertex attributes to set for each vertex
  **/
  @:uproperty public var HoleVertices : unreal.TArray<unreal.editablemesh.FVertexAndAttributes>;
