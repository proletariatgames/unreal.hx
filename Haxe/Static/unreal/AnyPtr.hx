...
abstract AnyPtr(UIntPtr) from UIntPtr to UIntPtr {
  ...
  public function getInt(at:Int):Int {
    var curThis = this + at;
    var ptr:cpp.Pointer<Int> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
    return ptr.value;
  }

  public function getInt8(at:Int):Int {
    var curThis = this + at;
    var ptr:cpp.Pointer<Int8> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
    return ptr.value;
  }

  public function getInt16(at:Int):Int {
    var curThis = this + at;
    var ptr:cpp.Pointer<Int16> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
    return ptr.value;
  }

  public function getInt64(at:Int):Int64 {
    var curThis = this + at;
    var ptr:cpp.Pointer<Int64> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
    return ptr.value;
  }

  public function getUInt(at:Int):UInt {
    var curThis = this + at;
    var ptr:cpp.Pointer<UInt> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
    return ptr.value;
  }

  public function getUInt8(at:Int):Int {
    var curThis = this + at;
    var ptr:cpp.Pointer<UInt8> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
    return ptr.value;
  }

  public function getUInt16(at:Int):Int {
    var curThis = this + at;
    var ptr:cpp.Pointer<UInt16> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
    return ptr.value;
  }

  public function getUInt64(at:Int):UInt64 {
    var curThis = this + at;
    var ptr:cpp.Pointer<UInt64> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
    return ptr.value;
  }

  public function getFloat32(at:Int):Float32 {
    var curThis = this + at;
    var ptr:cpp.Pointer<Float32> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
    return ptr.value;
  }

  public function getFloat(at:Int):Float {
    var curThis = this + at;
    var ptr:cpp.Pointer<Float> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
    return ptr.value;
  }

  public function getBool(at:Int):Bool {
    var curThis = this + at;
    var ptr:cpp.Pointer<Bool> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
    return ptr.value;
  }

  public function setUObject(at:Int, val:UObject):Void {
    var curThis = this + at;
    var ptr:cpp.Pointer<UIntPtr> = cpp.Pointer.fromRaw(untyped __cpp__("(void*){0}", curThis));
