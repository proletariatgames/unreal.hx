...
// ensure that these types are compiled since we implement special reflection support for them
...
import unreal.TSoftObjectPtr;

import unreal.TSoftClassPtr;
...
<files id=\"runtime\">
  <compilerflag value='-DHX_MEMORY_H_OVERRIDE=\"${HX_MEMORY_H_OVERRIDE}\"' if=\"HX_MEMORY_H_OVERRIDE\" />
</files>
")
